//======================================================================
/**
 * @file gfl2_tinymt64.cpp
 * @date 2015/12/22 19:57:22
 * @author araki_syo
 * @brief 64bit Tiny MT source file (from https://github.com/MersenneTwister-Lab/TinyMT/blob/master/tinymt/tinymt64.c)
 * @par Copyright
