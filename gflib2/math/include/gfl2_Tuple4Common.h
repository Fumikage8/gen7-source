 ...
 */
inline bool IsSimilar( const parent_type& t, const f32 epsilon = EPSILON ) const {
 ...
 */
inline bool IsAlmostZero( const f32 epsilon = EPSILON ) const {
 ...
 * @return 無し
 */
inline void Abs( const Vector& t ) {
