//======================================================================
/**
 * @file gfl2_tinymt64.h
 * @date 2015/12/22 19:54:24
 * @author araki_syo
 * @brief 64bit Tiny MT header file (from https://github.com/MersenneTwister-Lab/TinyMT/blob/master/tinymt/tinymt64.h)
 * @par Copyright
