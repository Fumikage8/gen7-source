#ifndef __GFL2_CAMERA_H__
#define __GFL2_CAMERA_H__
//[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[
/**
 *  GAME FREAK inc.
 *
...
//デフォルト設定
static const f32 CAMERA_DEFAULT_FOVY   = math::ConvDegToRad(40);
...
static const gfl2::math::PivotDirection CAMERA_DEFAULT_PIVOT  = gfl2::math::PIVOT_UPSIDE_TO_TOP;
...
//=====================================
typedef struct {
  gfl2::math::Vector3 pos;        //カメラ座標
  gfl2::math::Vector3 up;         //上方向
  gfl2::math::Vector3 target;     //ターゲット座標
} ViewParam;
...
typedef struct {
  ...
  f32                       proj_near;       //ニアの距離
  f32                       proj_far;        //ファーの距離
  gfl2::math::PivotDirection pivot;      //回転処理設定
} ProjectionParam;
...
public:
   ...
   */
  //-----------------------------------------------------------------------------
  void SetUpFrustum( f32 l, f32 r, f32 b, f32 t, f32 near, f32 far, gfl2::math::PivotDirection pivot );
   ...
   */
  //-----------------------------------------------------------------------------
  void SetUpPerspective( f32 fovy, f32 aspect, f32 near, f32 far, gfl2::math::PivotDirection pivot );
   ...
   */
  //-----------------------------------------------------------------------------
  void SetUpOrtho( f32 l, f32 r, f32 b, f32 t, f32 near, f32 far, gfl2::math::PivotDirection pivot );
   ...
   */
  //-----------------------------------------------------------------------------
  void SetUpProjection( const gfl2::math::Matrix44& projection );
   ...
   */
  //-----------------------------------------------------------------------------
  void SetUpLookAt( const gfl2::math::Vector3& pos, const gfl2::math::Vector3& up, const gfl2::math::Vector3& target );
   ...
   */
  //-----------------------------------------------------------------------------
  void SetUpLookAt( const gfl2::math::Matrix34& view );
   ...
   */
  //-----------------------------------------------------------------------------
  const gfl2::math::Matrix34& GetViewMtx( void ) const;
   ...
   */
  //-----------------------------------------------------------------------------
  const gfl2::math::Matrix44& GetProjectionMtx( void ) const;
   ...
   */
  //-----------------------------------------------------------------------------
  void SetCameraPos( const gfl2::math::Vector3& pos );
   ...
   */
  //-----------------------------------------------------------------------------
  const gfl2::math::Vector3& GetCameraPos( void ) const;
   ...
   */
  //-----------------------------------------------------------------------------
  void SetCameraUp( const gfl2::math::Vector3& up );
   ...
   */
  //-----------------------------------------------------------------------------
  const gfl2::math::Vector3& GetCameraUp( void ) const;
   ...
   */
  //-----------------------------------------------------------------------------
  void SetCameraTarget( const gfl2::math::Vector3& target );
   ...
   */
  //-----------------------------------------------------------------------------
  const gfl2::math::Vector3& GetCameraTarget( void ) const;
...
private:
  ...
  // 行列
  gfl2::math::Matrix34 m_view;
  gfl2::math::Matrix44 m_proj;
};
