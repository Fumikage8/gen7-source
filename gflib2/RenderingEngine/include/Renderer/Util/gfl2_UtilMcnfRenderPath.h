...
#ifndef GFLIB2_RENDERINGENGINE_RENDERER_UtilMcnfRenderPath_H_INCLUDED
#define GFLIB2_RENDERINGENGINE_RENDERER_UtilMcnfRenderPath_H_INCLUDED
...
//-----------------------------------------------------------
//! @brief モーションコンフィグ描画パスクラス
//-----------------------------------------------------------
class McnfRenderPath : public RenderingPipeLine::IRenderPath
{
public:
