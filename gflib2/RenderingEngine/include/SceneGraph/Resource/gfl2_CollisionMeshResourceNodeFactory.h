#ifndef GFLIB2_RENDERINGENGINE_SCENEGRAPH_RESOURCE_CollisionMeshResourceNodeFAACTRY_H_INCLUDED
#define GFLIB2_RENDERINGENGINE_SCENEGRAPH_RESOURCE_CollisionMeshResourceNodeFAACTRY_H_INCLUDED
...
/**
	* @brief メッシュリソースノードのファクトリインターフェース
	*/
class CollisionMeshResourceNodeFactory : public IResourceNodeFactory
{
public:

	CollisionMeshResourceNodeFactory():IResourceNodeFactory(){}
	virtual ~CollisionMeshResourceNodeFactory() {}
