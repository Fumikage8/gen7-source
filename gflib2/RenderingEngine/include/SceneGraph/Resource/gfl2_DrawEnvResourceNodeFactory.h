#ifndef GFLIB2_RENDERINGENGINE_SCENEGRAPH_RESOURCE_DrawEnvRESOURCENODEFAACTRY_H_INCLUDED
#define GFLIB2_RENDERINGENGINE_SCENEGRAPH_RESOURCE_DrawEnvRESOURCENODEFAACTRY_H_INCLUDED
...
/**
	* @brief DrawEnvリソースノードのファクトリインターフェース
	*/
class DrawEnvResourceNodeFactory : public IResourceNodeFactory
{
public:

	DrawEnvResourceNodeFactory():IResourceNodeFactory(){}
	virtual ~DrawEnvResourceNodeFactory() {}
