#ifndef GFLIB2_RENDERINGENGINE_SCENEGRAPH_RESOURCE_SHADERRESOURCENODEFAACTRY_H_INCLUDED
#define GFLIB2_RENDERINGENGINE_SCENEGRAPH_RESOURCE_SHADERRESOURCENODEFAACTRY_H_INCLUDED
...
/**
	* @brief シェーダーリソースノードのファクトリインターフェース
	*/
class ShaderResourceNodeFactory : public IResourceNodeFactory
{
public:

	ShaderResourceNodeFactory():IResourceNodeFactory(){}
	virtual ~ShaderResourceNodeFactory() {}
