#ifndef GFLIB2_RENDERINGENGINE_SCENEGRAPH_RESOURCE_GfBinaryMdlDataPackFactory_H_INCLUDED
#define GFLIB2_RENDERINGENGINE_SCENEGRAPH_RESOURCE_GfBinaryMdlDataPackFactory_H_INCLUDED
...
/**
	...
	*/
class GfBinaryMdlDataPackFactory : public IResourceNodeFactory
{
public:

	GfBinaryMdlDataPackFactory():IResourceNodeFactory(){}
	virtual ~GfBinaryMdlDataPackFactory() {}
