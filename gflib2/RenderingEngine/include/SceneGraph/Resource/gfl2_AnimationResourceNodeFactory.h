#ifndef GFLIB2_RENDERINGENGINE_SCENEGRAPH_RESOURCE_AnimationRESOURCENODEFAACTRY_H_INCLUDED
#define GFLIB2_RENDERINGENGINE_SCENEGRAPH_RESOURCE_AnimationRESOURCENODEFAACTRY_H_INCLUDED
...
/**
	* @brief アニメーションリソースノードのファクトリインターフェース
	*/
class AnimationResourceNodeFactory : public IResourceNodeFactory
{
public:

	AnimationResourceNodeFactory():IResourceNodeFactory(){}
	virtual ~AnimationResourceNodeFactory() {}
