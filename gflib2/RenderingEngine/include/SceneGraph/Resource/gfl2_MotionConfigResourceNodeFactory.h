#ifndef GFLIB2_RENDERINGENGINE_SCENEGRAPH_RESOURCE_MOTIONCONFIGRESOURCENODEFAACTRY_H_INCLUDED
#define GFLIB2_RENDERINGENGINE_SCENEGRAPH_RESOURCE_MOTIONCONFIGRESOURCENODEFAACTRY_H_INCLUDED
...
/**
	* @brief モーション設定リソースノードのファクトリインターフェース
	*/
class MotionConfigResourceNodeFactory : public IResourceNodeFactory
{
public:

	MotionConfigResourceNodeFactory():IResourceNodeFactory(){}
	virtual ~MotionConfigResourceNodeFactory() {}
