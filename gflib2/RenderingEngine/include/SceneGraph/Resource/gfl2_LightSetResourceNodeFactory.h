#ifndef GFLIB2_RENDERINGENGINE_SCENEGRAPH_RESOURCE_LightSetRESOURCENODEFAACTRY_H_INCLUDED
#define GFLIB2_RENDERINGENGINE_SCENEGRAPH_RESOURCE_LightSetRESOURCENODEFAACTRY_H_INCLUDED
...
/**
	* @brief LightSetリソースノードのファクトリインターフェース
	*/
class LightSetResourceNodeFactory : public IResourceNodeFactory
{
public:

	LightSetResourceNodeFactory():IResourceNodeFactory(){}
	virtual ~LightSetResourceNodeFactory() {}
