#ifndef GFLIB2_RENDERINGENGINE_SCENEGRAPH_RESOURCE_GfMotData_H_INCLUDED
#define GFLIB2_RENDERINGENGINE_SCENEGRAPH_RESOURCE_GfMotData_H_INCLUDED
 ...
 * @brief	GfMotDataクラス
 */
class GfMotData : public IResourceData
{
public:
	GfMotData();
	//GfMotData(c8* pMotionData);				//! @note 暗黙の型変換に注意！
	GfMotData(::std::string filePath);	//! @note 暗黙の型変換に注意！
	...
	{
		return IResourceData::Type("gfmot");
	}
