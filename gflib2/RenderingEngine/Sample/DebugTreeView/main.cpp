...
public:
  ...
  DebugWindowProc*                                          m_pDebugWindowProc;
    ...
    m_pModelInstanceNode[0]->SetNodeName("L --- Pikachu");
    m_pModelInstanceNode[1]->SetNodeName("R --- Pikachu");

    // 左腕にピカチュウをアタッチしてみる
    m_pModelInstanceNode[0]->GetJointInstanceNode(17)->AddChild(m_pModelInstanceNode[1]);
