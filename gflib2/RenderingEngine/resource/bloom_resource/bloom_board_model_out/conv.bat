...
R:/home/niji/tool/ModelConverter/ModelConverter.exe -i "exports/bloom_board_model.gfmdl" -o "binary/wingl/bloom_board_model.wingl.gfbmdl"
R:/home/niji/tool/ModelConverter/ModelConverter.exe -i "exports/bloom_board_model.gfmdl" -o "binary/ctr/bloom_board_model.ctr.gfbmdl"
