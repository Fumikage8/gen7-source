...
R:/home/niji/tool/ModelConverter/ModelConverter.exe -i "exports/bloom_high_luminance_model_rgbxa.gfmdl" -o "binary/wingl/bloom_high_luminance_model_rgbxa.wingl.gfbmdl"
R:/home/niji/tool/ModelConverter/ModelConverter.exe -i "exports/bloom_high_luminance_model_rgbxa.gfmdl" -o "binary/ctr/bloom_high_luminance_model_rgbxa.ctr.gfbmdl"
