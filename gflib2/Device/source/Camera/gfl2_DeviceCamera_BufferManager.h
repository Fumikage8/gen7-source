#if GF_PLATFORM_CTR
#if !defined( GFL2_DEVICECAMERA_BUFFERMANAGER_H_INCLUDE )
#define GFL2_DEVICECAMERA_BUFFERMANAGER_H_INCLUDE
/////////////////////////////////////////////////////////////////////////////////////////
/**
 * @file   gfl2_DeviceCamera_BufferManager.h
...
GFL_NAMESPACE_BEGIN(camera)
      ...
      class BufferManager 
      {
         ...
         */
        struct SetupParam {
          gfl2::heap::HeapBase* pHeap;         // バッファの確保に使用するヒープ
...
#endif // GFL2_DEVICECAMERA_BUFFERMANAGER_H_INCLUDE
