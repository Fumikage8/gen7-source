//=============================================================================
/**
 * @file   gfl2_UI_DeviceImplementerForAccelerometer.h
 * @brief  加速度センサ入力の検出クラス専用インターフェース
 * @author obata_toshihiro
 * @date   2011.03.24
 */
//=============================================================================
#ifndef __gfl2_UI_DEVICE_IMPLEMENTER_FOR_ACCELEROMETER_H__
#define __gfl2_UI_DEVICE_IMPLEMENTER_FOR_ACCELEROMETER_H__
...
namespace gfl2 {
  namespace ui {
    ...
    { 
       ...
       */
      //-----------------------------------------------------------------------
      virtual void GetOffset( gfl2::math::VEC3* buffer ) const = 0;
       ...
       */
      //-----------------------------------------------------------------------
      virtual void SetOffset( const gfl2::math::VEC3& offset ) = 0;
...
#endif  //__gfl2_UI_DEVICE_IMPLEMENTER_FOR_ACCELEROMETER_H__
