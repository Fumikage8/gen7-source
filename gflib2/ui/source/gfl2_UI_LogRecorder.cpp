...
namespace gfl2 {
  namespace ui {
     ...
     */
    //-------------------------------------------------------------------------
    void LogRecorder::AllocBuffer( gfl2::heap::HeapBase* heap, u32 buffer_size )
    {
    ...
    {
      GFL_PRINT("LogRecorder::ClearLog m_recDataIdx %d \n", m_recDataIdx );
      m_recDataIdx = 0;
    } 
    ...
    void LogRecorder::GetLogData( u32 index, void* p_buffer ) const
    {
      ...
      gfl2::std::MemCopy( p_data, p_buffer, data_size );
    }
