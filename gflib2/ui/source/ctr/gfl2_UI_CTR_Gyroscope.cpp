//=============================================================================
/**
 * @file   gfl2_UI_CTR_Gyroscope.cpp
...
namespace gfl2 {
  namespace ui {
     ...
     */
    //-------------------------------------------------------------------------
    const gfl2::math::VEC3& CTR_Gyroscope::GetAngleMagnification( void ) const
    {
     ...
     */
    //--------------------------------------------------------------------------
    void CTR_Gyroscope::SetDirection( const gfl2::math::MTX33& mtx )
    {
     ...
     */
    //-------------------------------------------------------------------------
    void CTR_Gyroscope::SetAngleMagnification( const gfl2::math::VEC3& value )
    {
     ...
     */
    //-------------------------------------------------------------------------
    void CTR_Gyroscope::GetAxisRotationMatrix( gfl2::math::MTX34* buffer ) const
    {
     ...
     */
    //-------------------------------------------------------------------------
    void CTR_Gyroscope::SetAxisRotationMatrix( const gfl2::math::MTX34& matrix )
    {
