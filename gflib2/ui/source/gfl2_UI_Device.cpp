...
#include "./gfl2_UI_LogPlayer.h"
#include "./gfl2_UI_LogRecorder.h"
...
namespace gfl2 {
  namespace ui {
     ...
     */
    //-------------------------------------------------------------------------
    Device::Device( gfl2::heap::HeapBase* heap, DeviceImplementer* implementer ) :
     ...
     */
    //-------------------------------------------------------------------------
    void Device::AllocLogBuffer( gfl2::heap::HeapBase* heap, u32 buffer_size )
    {
    ...
    void Device::UpdateRawEffectiveData( void )
    {
      ...
      gfl2::std::MemCopy( m_nowRawDetectiveData, m_prevRawDetectiveData, detective_datasize );
      ...
      if( this->IsOnEffectiveDataUpdateFrame() ) {
        ...
        gfl2::std::MemCopy( m_rawEffectiveDataBuffer, m_rawEffectiveData, effective_datasize );
        gfl2::std::MemClear( m_rawEffectiveDataBuffer, effective_datasize );
      }
    }
    ...
    void Device::CopyNowDetectiveData_ToPrevDetectiveData( void )
    {
      ...
      gfl2::std::MemCopy( m_nowDetectiveData, m_prevDetectiveData, data_size );
    }
    ...
    {
      u32 data_size = m_pImplementer->GetDetectiveDataSize(); 
      return (gfl2::std::MemComp( m_nowDetectiveData, m_prevDetectiveData, data_size) == 0); // ビット単位で同じなら, リピートとする
    } 
    ...
    void Device::CopyEffectiveDataBuffer_ToEffectiveData( void )
    {
      ...
      gfl2::std::MemCopy( m_effectiveDataBuffer, m_effectiveData, data_size );
    }
    ...
    {
      u32 data_size = m_pImplementer->GetEffectiveDataSize();
      gfl2::std::MemClear( m_effectiveDataBuffer, data_size );
    }
