//=============================================================================
/**
 * @file   gfl2_UI_Types.h
 * @brief  UIシステムで使用する型
 * @author obata_toshihiro
 * @date   2010.11.08
 */
//=============================================================================
#ifndef __gfl2_UI_TYPES_H__
#define __gfl2_UI_TYPES_H__ 
#pragma once

#if GFL_DEBUG
#define GFL2_UI_USE_DEBUG_PAD  // 定義してあると, デバッグパッドが有効になる
#endif

// SBTS[631] 【ガイドライン】ジャイロセンサの使用の有無について
// GFL2_UI_USE_GYROSCOPE定義状態では、 ジャイロセンサーの処理が動作しないようにする。
