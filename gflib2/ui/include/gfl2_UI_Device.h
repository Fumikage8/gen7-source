//=============================================================================
/**
 * @file   gfl2_UI_Device.h
 * @brief  入力デバイスの抽象クラス
 * @author obata_toshihiro
 * @date   2010.10.22
 */
//=============================================================================
#ifndef __gfl2_UI_DEVICE_H__
#define __gfl2_UI_DEVICE_H__
#pragma once
...
namespace gfl2 {
  namespace ui {
    ...
    class Device 
    {
       ...
       */
      //-----------------------------------------------------------------------
      void AllocLogBuffer( gfl2::heap::HeapBase* heap, u32 buffer_size );
       ...
       */
      Device( gfl2::heap::HeapBase* heap, DeviceImplementer* implementer );
