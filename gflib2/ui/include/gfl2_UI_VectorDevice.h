//=============================================================================
/**
 * @file   gfl2_UI_VectorDevice.h
 * @brief  方向入力デバイスのアクセッサ
 * @author obata_toshihiro
 * @date   2010.10.21
 */
//=============================================================================
#ifndef __gfl2_UI_VECTORDEVICE_H__
#define __gfl2_UI_VECTORDEVICE_H__
#pragma once
...
namespace gfl2 {
  namespace ui {
    ...
    class VectorDevice : public Device 
    {
       ...
       */
      //-----------------------------------------------------------------------
      void GetVector( gfl2::math::VEC2* dest_vec ) const;
       ...
       */
      //-----------------------------------------------------------------------
      void GetVector( gfl2::math::VEC3* dest_vec ) const; 
       ...
       */
      VectorDevice( gfl2::heap::HeapBase* heap, DeviceImplementerForVectorDevice* implementer );
...
#endif // __gfl2_UI_VECTORDEVICE_H__
