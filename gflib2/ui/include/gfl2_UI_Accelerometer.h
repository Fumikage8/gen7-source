 ...
 * @file   gfl2_UI_Accelerometer.h
 * @author obata_toshihiro
 * @date   2011.03.24
 */
//=============================================================================
#ifndef __gfl2_UI_ACCELEROMETER_H__
#define __gfl2_UI_ACCELEROMETER_H__
#pragma once
...
namespace gfl2 {
  namespace ui {
    ...
    class Accelerometer : public Device
    {
       ...
       */
      //-----------------------------------------------------------------------
      void GetMeasuredValue( gfl2::math::VEC3* buffer ) const;
       ...
       */
      //-----------------------------------------------------------------------
      void GetAcceleration( gfl2::math::VEC3* buffer ) const;
       ...
       */
      //-----------------------------------------------------------------------
      void GetOffset( gfl2::math::VEC3* buffer ) const;
       ...
       */
      //-----------------------------------------------------------------------
      void SetOffset( const gfl2::math::VEC3& offset );
       ...
       */
      Accelerometer( gfl2::heap::HeapBase* heap, DeviceImplementerForAccelerometer* implementer );
...
#endif  //__gfl2_UI_ACCELEROMETER_H__
