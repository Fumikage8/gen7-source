...
public:
  ...
  VoidHashList( GET_KEY_FUNC func = 0, const s32 size = 0, gfl2::heap::HeapBase* heap = 0 );
  ...
  void SetHeap( gfl2::heap::HeapBase* Heap );
...
public:
  ...
  HashList( GET_KEY_FUNC func, const s32 size = 0, gfl2::heap::HeapBase* heap=0 ) : VoidHashList( func, size, heap ) {
  }
