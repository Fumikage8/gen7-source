...
#  define PAWN_BIG_ENDIAN    4321
#  define PAWN_LITTLE_ENDIAN 1234
#  if (CYG_BYTEORDER == CYG_LSBFIRST)
#    define BYTE_ORDER  PAWN_LITTLE_ENDIAN
#  else
#    define BYTE_ORDER  PAWN_BIG_ENDIAN
#  endif
   /*
...
/* Linux now has these */
#if !defined PAWN_BIG_ENDIAN
  #define PAWN_BIG_ENDIAN    4321
#endif
#if !defined PAWN_LITTLE_ENDIAN
  #define PAWN_LITTLE_ENDIAN 1234
#endif
...
-------------------------------------------------------------
*/
//    #include <stdlib.h> // GameFreak this causes errors
  #endif
