...
-------------------------------------------------------------
*/
#define GFL_PAWN_USE_HASH 1 // GameFreak ラベルをハッシュに変更する
#define GFL_PAWN_OMIT_OFFSET GFL_PAWN_USE_HASH
...
#include <limits.h>
   ...
   * with modification from S?en Hannibal
   */
...
#define sNAMEMAX        63      /* maximum name length of symbol name */ /* GameFreak enlarges this buffer. */
