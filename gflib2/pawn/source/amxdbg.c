...
#include <stdlib.h>
#include <string.h>
#include "pawn/include/osdefs.h"     /* for _MAX_PATH */
#include "pawn/include/amx.h"
#include "pawn/include/amxdbg.h"
...
// GameFreak
#define CHECK_AMXDBG_HEADER(amxdbg)  if(!amxdbg->hdr){  return AMX_ERR_NOTFOUND;  }
...
int AMXAPI dbg_LookupFile(AMX_DBG *amxdbg, ucell address, const char **filename)
{
  ...
  CHECK_AMXDBG_HEADER(amxdbg);  // GameFreak
  *filename = NULL;
