...
public:
  ...
  u32                                       m_AnimationNo;                        ///< アニメーション番号
	...
	virtual bool OnInit( void )
	{
		...
		{
			static const c8* s_pModelFilePath = "../data/anim_sample/chip_sea_opt.mb.gfmdl";
			//static const c8* s_pAnimationFilePath = "../data/anim_sample/sea_opt.gfmot";
			static const c8* s_pAnimationFilePath = "R:/home/niji/git_program/tool_project/AnimationConverter/test_file/new_format/chip_sea_opt.mb.bgfmot";
	...
	virtual bool OnUpdate( void )
	{
		{
			// ビュー変換行列
			math::Vector3 eyePosition( 0.0f, 150.0f, 100.0f );  // 視点(カメラの位置)
    ...
    math::Quaternion rot;
    rot.RadianToQuaternion(0, math::ConvDegToRad(10), 0);
