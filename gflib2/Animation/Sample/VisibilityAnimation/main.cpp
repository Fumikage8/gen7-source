...
public:
  ...
  u32                                       m_AnimationNo;                        ///< アニメーション番号
	...
	virtual bool OnInit( void )
	{
		...
		{
			static const c8* s_pModelFilePath = "../data/pm0722_00_hedgehog3/pm0722_00.mb.gfmdl";
			static const c8* s_pAnimationFilePath = "../data/pm0722_00_hedgehog3/pm0722_00_ba21_tokusyu02.gfmot";
			//static const c8* s_pAnimationFilePath = "R:/home/niji/git_program/tool_project/AnimationConverter/test_file/new_format/pm0722_00_ba21_tokusyu02.bgfmot";
      ...
      //s32 fileSize = 0;
      //c8* pMotData = this->ReadFile(s_pAnimationFilePath, &fileSize);
      //animationResourceData.SetMotionData(pMotData, fileSize);
      ...
      pMaterialSlot->SetAnimationResource(m_pAnimationResourceRootNode);
      pMaterialSlot->SetStepFrame(SC_STEP_FRAME);
      pMaterialSlot->SetLoop(true);

      // ビジビリティアニメーション
      VisibilityAnimationSlot* pVisibilitySlot = m_AnimationController.GetVisibilitySlot();
      pVisibilitySlot->SetAnimationResource(m_pAnimationResourceRootNode);
      pVisibilitySlot->SetStepFrame(SC_STEP_FRAME);
    ...
    m_pModelInstanceNode->SetLocalTranslate(math::Vector3(0, 20, 0));
    math::Quaternion rot;
