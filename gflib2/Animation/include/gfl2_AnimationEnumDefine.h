	...
	#define		NAME_SPACE_BEGIN		namespace gfl2 { namespace clr { namespace animation {
	...
	#define		NAME_SPACE_BEGIN		namespace gfl2 { namespace animation {
	#define		NAME_SPACE_END			}}
...
NAME_SPACE_BEGIN
	...
	//-------------------------------------------------------------------------------------------------------------------------------------------------
	//! @brief 上書き可能なパーツ区分
	DECLARE_ENUM_BEGIN( OverridePartsType )
		Eye01 = 0,
		Eye02,
		Eye03,
		Mouth01,
		Mouth02,
		Mouth03,
    Loop01,       // ループ再生(パッチールのブチ模様のため4つ必要)
    Loop02,
    Loop03,
    Loop04,
		NumberOf
	DECLARE_ENUM_END( OverridePartsType )
