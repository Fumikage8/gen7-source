#if !defined(V6_GFL2_FSARCFILEACCESSOR_FILEBLOCK_H_INCLUDED)
#define V6_GFL2_FSARCFILEACCESSOR_FILEBLOCK_H_INCLUDED
#pragma once
...
#endif  // V6_GFL2_FSARCFILEACCESSOR_FILEBLOCK_H_INCLUDED
