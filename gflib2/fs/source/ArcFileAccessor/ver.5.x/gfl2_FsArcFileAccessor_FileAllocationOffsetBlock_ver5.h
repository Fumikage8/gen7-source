#if !defined(V5_GFL2_FSARCFILEACCESSOR_FILEALLOCATIONOFFSETBLOCK_H_INCLUDED)
#define V5_GFL2_FSARCFILEACCESSOR_FILEALLOCATIONOFFSETBLOCK_H_INCLUDED
#pragma once
...
#endif  // V5_GFL2_FSARCFILEACCESSOR_FILEALLOCATIONOFFSETBLOCK_H_INCLUDED
