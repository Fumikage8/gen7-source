...
#include "./gfl2_FsArcFileAccessor_FileHeaderBlock.h"
#include "./gfl2_FsArcFileAccessor_FileAllocationOffsetBlock.h"
#include "./gfl2_FsArcFileAccessor_FileAllocationTableBlock.h"
#include "./gfl2_FsArcFileAccessor_FileImageBlock.h"
#include "./gfl2_FsArcFileAccessor.h"
...
GFL_NAMESPACE_BEGIN(ver4)
      ...
      {
        return m_file_header_block.MaxDataSize();  // ver.4.xではMaxDataSizeがパディングを除いたサイズになっている
      }
