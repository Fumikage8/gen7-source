#if !defined(V4_GFL2_FSARCFILEACCESSOR_FILEALLOCATIONOFFSETBLOCK_H_INCLUDED)
#define V4_GFL2_FSARCFILEACCESSOR_FILEALLOCATIONOFFSETBLOCK_H_INCLUDED
#pragma once
...
#endif  // V4_GFL2_FSARCFILEACCESSOR_FILEALLOCATIONOFFSETBLOCK_H_INCLUDED
