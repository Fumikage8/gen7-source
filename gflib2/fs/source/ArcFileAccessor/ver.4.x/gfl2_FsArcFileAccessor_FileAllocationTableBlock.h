#if !defined(V4_GFL2_FSARCFILEACCESSOR_FILEALLOCATIONTABLEBLOCK_H_INCLUDED)
#define V4_GFL2_FSARCFILEACCESSOR_FILEALLOCATIONTABLEBLOCK_H_INCLUDED
#pragma once
...
#endif  // V4_GFL2_FSARCFILEACCESSOR_FILEALLOCATIONTABLEBLOCK_H_INCLUDED
