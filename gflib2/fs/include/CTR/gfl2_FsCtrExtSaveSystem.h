...
class ExtSaveSystem
{
  ...
  /// constructor
  //-----------------------------------------------------------------------------
  ExtSaveSystem( gfl2::heap::HeapBase * pHeap );
   ...
   */
  //-----------------------------------------------------------------------------
  bool StartAsyncMountAndFormat( gfl2::heap::HeapBase * pHeap, u8 priority, const void * iconBuffer, size_t iconSize );
   ...
   */
  //-----------------------------------------------------------------------------
  bool StartAsyncMount( gfl2::heap::HeapBase * pHeap, u8 priority );
   ...
   */
  //-----------------------------------------------------------------------------
  bool StartAsyncUnmount( gfl2::heap::HeapBase * pHeap, u8 priority );
   ...
   */
  //-----------------------------------------------------------------------------
  bool StartAsyncGetArchiveInfo( gfl2::heap::HeapBase * pHeap, u8 priority );
   ...
   */
  //-----------------------------------------------------------------------------
  bool StartAsyncDeleteArchive( gfl2::heap::HeapBase * pHeap, u8 priority );
  ...
  private:
    ...
    gfl2::heap::HeapBase *     m_thread_heap;
