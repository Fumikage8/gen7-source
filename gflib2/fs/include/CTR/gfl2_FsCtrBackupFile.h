...
/**
 * @brief  バックアップファイル
 * @file   gfl2_FsCtrBackupFile.h
 * @author obata_toshihiro
 * @date   2011.02.16
 */
//=============================================================================
#ifndef __GFL2_BACKUPFILE_H__
#define __GFL2_BACKUPFILE_H__
#pragma once
...
namespace gfl2 {
  namespace fs {
    ...
    class FsCtrBackupFile //: public File
    {
      public:
         ...
         * @brief コンストラクタ
         */
        FsCtrBackupFile( void );

        /**
         * @brief デストラクタ
         */
        virtual ~FsCtrBackupFile( void );
         ...
         */
        virtual void Seek( u32 base_pos, s32 offset );
