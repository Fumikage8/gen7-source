 ...
 * @brief  キュー
 * @file   gfl2_Queue.h
 * @author obata_toshihiro->Miyuki Iwasawa
 * @date   2015.03.11
 */
//======================================================================================== 
#pragma once
  ...
  namespace base {
    ...
    template <class T> class Queue
    {
      public:
         ...
         */
        //--------------------------------------------------------------------------------
        Queue( gfl2::heap::HeapBase* heap, u32 max_data_num );
     ...
     */
    //--------------------------------------------------------------------------------
    template <class T> Queue<T>::Queue( gfl2::heap::HeapBase* heap, u32 max_data_num ) : 
