//===========================================================================
/**
 * @file  gfl2_StrBufReader.h
 * @brief GAMEFREAK Library String System ( String Buffer Reader)
 * @author  GAMEFREAK inc.
 * @date  2010.10.28
 */
//===========================================================================
#if !defined( GFL2_STRBUFREADER_H_INCLUDED )
#define GFL2_STRBUFREADER_H_INCLUDED
#pragma once
...
public:
  //---  コンストラクタ／デストラクタ -----------
  StrBufReader( gfl2::heap::HeapBase* pHeap );
   ...
   */
  //----------------------------------------------------------------------
  void  SetString( const StrBuf& srcBuf, gfl2::heap::HeapBase* pHeap );

  void  SetString( const STRCODE* str, u32 strLen, gfl2::heap::HeapBase* pHeap );
...
#endif // GFL2_STRBUFREADER_H_INCLUDED
