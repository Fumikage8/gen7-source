...
#ifndef __MENU_SAMPLE_FRAME_H__
#define __MENU_SAMPLE_FRAME_H__
#pragma once
...
class MenuSampleDraw;


class MenuSampleFrame : public applib::frame::CellSuper, public MenuSampleDrawListener
{
  GFL_FORBID_COPY_AND_ASSIGN(MenuSampleFrame);
...
private:
  ...
  MenuSampleDraw* mpMenuSampleDraw;
