//=============================================================================
/**
 * @file	 FieldMessageSampleFrame.h
 * @brief	 継承したテスト
 * @author k.ohno
 * @date	 2014.1.16
 */
...
#ifndef __FIELD_MESSAGE_SAMPLE_FRAME_H__
#define __FIELD_MESSAGE_SAMPLE_FRAME_H__
#pragma once
...
class FieldMessageSampleDraw;


class FieldMessageSampleFrame : public applib::frame::CellSuper, public FieldMessageSampleDrawListener
{
  GFL_FORBID_COPY_AND_ASSIGN(FieldMessageSampleFrame);
...
public:
   ...
   */
  //------------------------------------------------------------------
  virtual ~FieldMessageSampleFrame();
...
public:
  ...
  //FieldMessageSampleDrawListener
  //--------------------------------------------------------------------------
  /**
   * @brief   ボタン押下通知
   */
...
private:
  ...
  FieldMessageSampleDraw* mpFieldMessageSampleDraw;
...
#endif // __FIELD_MESSAGE_SAMPLE_FRAME_H__
