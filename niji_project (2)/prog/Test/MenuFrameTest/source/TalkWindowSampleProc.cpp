...
gfl2::proc::Result Proc::InitFunc(gfl2::proc::Manager* pManager)
{
  ...
  // ローカルヒープを作る
  mpAppHeap->LocalHeapCreate(appHeap,devHeap,  App::Tool::TalkWindow::SIZE_TALKWINDOW_APP+0x50000,  App::Tool::TalkWindow::SIZE_TALKWINDOW_APPDEV+0x50000);
  // ファイル読み込み用はローカルではなくAPP_DEVICEの後方からとる   2015.05.20修正
...
//  mpFrameManager->SetDispDebugNo(false);
  //自分のパイプラインを作成
