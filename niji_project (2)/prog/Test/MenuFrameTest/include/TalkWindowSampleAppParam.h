//=============================================================================
/**
 * @file	 TalkWindowSampleAppParam.h
 * @brief	 継承したテスト
 * @author k.ohno
 * @date	 2014.1.16
 */
...
#ifndef __TALK_WINDOW_SAMPLE_APP_PARAM_H__
#define __TALK_WINDOW_SAMPLE_APP_PARAM_H__
#pragma once
...
#endif //__TALK_WINDOW_SAMPLE_APP_PARAM_H__
