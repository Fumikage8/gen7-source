//===================================================================
/**
 *	@file	    TalkWindowSampleEvent.h
 *	@brief    TalkWindowのクラスの実験
 *	@author	  k.ohno
 *	@date		  2015.2.25
 *
 */
...
#ifndef __TALK_WINDOW_SAMPLE_EVENT_H__
#define __TALK_WINDOW_SAMPLE_EVENT_H__
#pragma once
...
//-----------------------------------------------------------------------------
  ...
  class TalkWindowSampleEvent : public GameSys::GameEvent
  {
    GFL_FORBID_COPY_AND_ASSIGN( TalkWindowSampleEvent ); // コピーを禁止
  ...
  public:
     ...
     */
    //--------------------------------------------------------------
    TalkWindowSampleEvent( gfl2::heap::HeapBase* heap);
    virtual ~TalkWindowSampleEvent();
  ...
  private:
    u32   mSeq;
    APP_PARAM mAppParam;
		Test::TalkWindowTest::Proc*  mpProc;
...
#endif // __TALK_WINDOW_SAMPLE_EVENT_H__
