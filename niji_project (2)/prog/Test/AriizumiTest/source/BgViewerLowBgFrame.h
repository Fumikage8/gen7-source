...
//=============================================================================
/**
 * @file	 BgViewerLowBgFrame.h
 * @brief	 BgViewerLowBgFrame
 * @author k.ohno
 * @date	 2015.7.14
 */
//=============================================================================
...
class BgViewerLowBgDraw;


class BgViewerLowBgFrame : public applib::frame::CellSuper, public BgViewerLowBgDrawListener
{
  GFL_FORBID_COPY_AND_ASSIGN(BgViewerLowBgFrame);
...
private:
  ...
  BgViewerLowBgDraw* mpBoxBgLowDraw;
