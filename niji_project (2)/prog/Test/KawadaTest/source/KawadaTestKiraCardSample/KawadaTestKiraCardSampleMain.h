#if !defined(NIJI_PROJECT_TEST_KAWADATESTKIRACARDSAMPLEMAIN_H_INCLUDED)
#define NIJI_PROJECT_TEST_KAWADATESTKIRACARDSAMPLEMAIN_H_INCLUDED
#pragma once


//==============================================================================
/**
 @file    KawadaTestKiraCardSampleMain.h
...
//==============================================================================
/**
 @class     KawadaTestKiraCardSampleMain
 @brief     KawadaTest
 */
//==============================================================================
class KawadaTestKiraCardSampleMain : public KawadaTestSampleBase
{
  GFL_FORBID_COPY_AND_ASSIGN(KawadaTestKiraCardSampleMain);

  ////////////////////////////////////////////////////////////////////////////////
public:
  KawadaTestKiraCardSampleMain(GameSys::GameManager* gameManager, gfl2::heap::HeapBase* parentHeapMem, gfl2::heap::HeapBase* parentDevMem);
  virtual ~KawadaTestKiraCardSampleMain();
...
private:
  ...
  // データマネージャ
  KawadaTestKiraCardSampleDataManager*  m_dataManager;

  // フレーム
  applib::frame::Manager*               m_frameManager;
  KawadaTestKiraCardSampleFrameListener*  m_frameListener;
  KawadaTestKiraCardSampleFrameCell*      m_frameCell;
...
#endif  // NIJI_PROJECT_TEST_KAWADATESTKIRACARDSAMPLEMAIN_H_INCLUDED
