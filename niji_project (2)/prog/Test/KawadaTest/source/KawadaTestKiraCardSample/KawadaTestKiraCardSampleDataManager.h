#if !defined(NIJI_PROJECT_TEST_KAWADATESTKIRACARDSAMPLEDATAMANAGER_H_INCLUDED)
#define NIJI_PROJECT_TEST_KAWADATESTKIRACARDSAMPLEDATAMANAGER_H_INCLUDED
#pragma once


//==============================================================================
/**
 @file    KawadaTestKiraCardSampleDataManager.h
...
class KawadaTestKiraCardSampleDataManager
{
  GFL_FORBID_COPY_AND_ASSIGN(KawadaTestKiraCardSampleDataManager);

public:
  //! @brief  データID
  enum DataId
  {
    DATA_ID_KIRA_CARD_TEST_APPLYT  = 0,
...
public:
  ...
  KawadaTestKiraCardSampleDataManager(app::util::Heap* appHeap, gfl2::fs::AsyncFileManager* romAsyncFileManager);
  virtual ~KawadaTestKiraCardSampleDataManager();
...
#endif  // NIJI_PROJECT_TEST_KAWADATESTKIRACARDSAMPLEDATAMANAGER_H_INCLUDED
