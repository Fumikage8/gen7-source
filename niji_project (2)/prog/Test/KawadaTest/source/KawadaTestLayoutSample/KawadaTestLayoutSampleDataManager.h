#if !defined(NIJI_PROJECT_TEST_KAWADATESTLAYOUTSAMPLEDATAMANAGER_H_INCLUDED)
#define NIJI_PROJECT_TEST_KAWADATESTLAYOUTSAMPLEDATAMANAGER_H_INCLUDED
#pragma once


//==============================================================================
/**
 @file    KawadaTestLayoutSampleDataManager.h
...
class KawadaTestLayoutSampleDataManager
{
  GFL_FORBID_COPY_AND_ASSIGN(KawadaTestLayoutSampleDataManager);
...
public:
  ...
  KawadaTestLayoutSampleDataManager(app::util::Heap* appHeap, gfl2::fs::AsyncFileManager* romAsyncFileManager);
  virtual ~KawadaTestLayoutSampleDataManager();
...
private:
  ...
  void getArcInfoOfDataId(const DataId a_dataId, gfl2::fs::ArcFile::ARCID* a_arcId, gfl2::fs::ArcFile::ARCID* a_arcDatId) const;
...
#endif  // NIJI_PROJECT_TEST_KAWADATESTLAYOUTSAMPLEDATAMANAGER_H_INCLUDED
