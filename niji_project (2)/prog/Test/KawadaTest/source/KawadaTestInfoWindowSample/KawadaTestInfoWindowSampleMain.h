#if !defined(NIJI_PROJECT_TEST_KAWADATESTINFOWINDOWSAMPLEMAIN_H_INCLUDED)
#define NIJI_PROJECT_TEST_KAWADATESTINFOWINDOWSAMPLEMAIN_H_INCLUDED
#pragma once


//==============================================================================
/**
 @file    KawadaTestInfoWindowSampleMain.h
...
//==============================================================================
/**
 @class     KawadaTestInfoWindowSampleMain
 @brief     KawadaTest
 */
//==============================================================================
class KawadaTestInfoWindowSampleMain : public KawadaTestSampleBase
{
  GFL_FORBID_COPY_AND_ASSIGN(KawadaTestInfoWindowSampleMain);

  ////////////////////////////////////////////////////////////////////////////////
public:
  KawadaTestInfoWindowSampleMain(GameSys::GameManager* gameManager, gfl2::heap::HeapBase* parentHeapMem, gfl2::heap::HeapBase* parentDevMem);
  virtual ~KawadaTestInfoWindowSampleMain();
...
private:
  ...
  // データマネージャ
  KawadaTestInfoWindowSampleDataManager*  m_dataManager;

  // フレーム
  applib::frame::Manager*               m_frameManager;
  KawadaTestInfoWindowSampleFrameListener*  m_frameListener;
...
#endif  // NIJI_PROJECT_TEST_KAWADATESTINFOWINDOWSAMPLEMAIN_H_INCLUDED
