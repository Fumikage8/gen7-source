//======================================================================
/**
 * @file CharaViewerRenderingPipeline.h
...
#if !defined __CHARA_VIEWER_RENDERING_PIPELINE__
#define __CHARA_VIEWER_RENDERING_PIPELINE__
#pragma once
 ...
 * @brief レンダリングパイプライン
 */
class CharaViewerRenderingPipeline : public gfl2::renderingengine::renderer::RenderingPipeLine
{
  GFL_FORBID_COPY_AND_ASSIGN(CharaViewerRenderingPipeline);

public:

  CharaViewerRenderingPipeline();
  virtual ~CharaViewerRenderingPipeline();
