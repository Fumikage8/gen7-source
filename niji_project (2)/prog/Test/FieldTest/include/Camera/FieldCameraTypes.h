...
* @brief   フィールド上のカメラ関連定義
* @author  ikuta_junya
* @date    2014.09.26
*/

#if !defined( FIELDCAMERATYPES_H_INCLUDED )
#define FIELDCAMERATYPES_H_INCLUDED
#pragma once
...
{
  gfl2::math::Vector( 0.0f, 0.0f, 0.0f ),
  gfl2::math::Vector( 0.0f, 0.0f, 0.0f ),
  0,0,0,0,0,0
};
...
{
  gfl2::math::Vector  rotate;
  f32                 distance;
  CoordinateSystemType  targetOffsetType;
  gfl2::math::Vector    targetOffset;
  gfl2::math::Vector  rotateBufferMin;
  gfl2::math::Vector  rotateBufferMax;
...
{
  gfl2::math::Vector  referencePoint;
  gfl2::math::Vector  rotate;
  f32                 distance;
};
...
inline void Clamp( const gfl2::math::Vector& rSrc, const LIMIT_DATA& rData, gfl2::math::Vector* pOut )
{
  // rSrc == pOutでも動作させる
...
inline void Clamp( const gfl2::math::Vector& rSrc, const LIMIT_DATA& rData, const LIMIT_DATA& rData2, gfl2::math::Vector* pOut )
{
  // rSrc == pOutでも動作させる
  // @todo min > max の場合どうする？
...
#endif // #if !defined( FIELDCAMERATYPES_H_INCLUDED )
