...
#if !defined( WEATHER_EFFECT_SHINE_H_INCLUDED )
#define WEATHER_EFFECT_SHINE_H_INCLUDED
#pragma once
...
class WeatherEffectShine : public WeatherEffectBase
{
  GFL_FORBID_COPY_AND_ASSIGN(WeatherEffectShine); //コピーコンストラクタ＋代入禁止
...
public:
   ...
   */
  WeatherEffectShine( gfl2::heap::HeapBase* pSystemHeap, gfl2::gfx::IGLAllocator* pGLAllocator, Field::Effect::Manager* pEffectManager);
  ///< デストラクタ
  virtual ~WeatherEffectShine();
...
#endif // WEATHER_EFFECT_SHINE_H_INCLUDED
