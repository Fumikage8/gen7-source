/**
* @file    SkeltonNameManglingManager.cpp
* @brief   名前修飾を管理クラス
* @author  ikuta_junya
* @date    2014.10.09
*/
...
#include "Test/Skelton/include//SkeltonNameManglingManager.h"
...
SkeltonNameManglingS32Node::SkeltonNameManglingS32Node( void ) : m_pInstance( NULL )
{
...
SkeltonNameManglingS32Node::~SkeltonNameManglingS32Node( void )
{
  delete m_pHash;
}

// 名前修飾を設定
void SkeltonNameManglingS32Node::SetSkeltonNameMangling( s32* pInstance, const char* pName )
{
...
// 値を設定
void SkeltonNameManglingS32Node::SetValue( s32 value ) 
{
  if( m_pInstance == NULL )
  {
    return;
...
// 値をテキストフォーマットで設定
b32 SkeltonNameManglingS32Node::SetValue( const char* pValue )
{
  if( m_pInstance == NULL )
  {
    return false;
...
// ハッシュ値を追加
b32 SkeltonNameManglingS32Node::AddHash( const char* pValue, s32 value )
{
  m_pHash->AddSkeltonNameMangling( pValue, value );
  return true;
}
...
SkeltonNameManglingU32Node::SkeltonNameManglingU32Node( void ) : m_pInstance( NULL )
{
}

SkeltonNameManglingU32Node::~SkeltonNameManglingU32Node( void )
{
}

// 名前修飾を設定
void SkeltonNameManglingU32Node::SetSkeltonNameMangling( u32* pInstance, const char* pName )
{
  m_pInstance = pInstance;
  m_Name = std::string( pName );
}
...
// 値を設定
void SkeltonNameManglingU32Node::SetValue( u32 value ) 
{
  if( m_pInstance == NULL )
  {
    return;
...
// 値をテキストフォーマットで設定
b32 SkeltonNameManglingU32Node::SetValue( const char* pValue )
{
  if( m_pInstance == NULL )
  {
    return false;
...
SkeltonNameManglingU16Node::SkeltonNameManglingU16Node( void ) : m_pInstance( NULL )
{
}

SkeltonNameManglingU16Node::~SkeltonNameManglingU16Node( void )
{
}

// 名前修飾を設定
void SkeltonNameManglingU16Node::SetSkeltonNameMangling( u16* pInstance, const char* pName )
{
  m_pInstance = pInstance;
  m_Name = std::string( pName );
}
...
// 値を設定
void SkeltonNameManglingU16Node::SetValue( u16 value ) 
{
  if( m_pInstance == NULL )
  {
    return;
...
// 値をテキストフォーマットで設定
b32 SkeltonNameManglingU16Node::SetValue( const char* pValue )
{
  if( m_pInstance == NULL )
  {
    return false;
...
SkeltonNameManglingStringNode::SkeltonNameManglingStringNode( void ) : m_pInstance( NULL ), m_Size( 0 )
{
}

SkeltonNameManglingStringNode::~SkeltonNameManglingStringNode( void )
{

}

// 名前修飾を設定
void SkeltonNameManglingStringNode::SetSkeltonNameMangling( const char* pName, c8* pInstance, u32 size )
{
  m_Name = std::string( pName );
  m_pInstance = pInstance;
  m_Size = size;
...
// 値をテキストフォーマットで設定
b32 SkeltonNameManglingStringNode::SetValue( const char* pValue )
{
...
SkeltonNameManglingWStringNode::SkeltonNameManglingWStringNode( void ) : m_pInstance( NULL ), m_Size( 0 )
{
}

SkeltonNameManglingWStringNode::~SkeltonNameManglingWStringNode( void )
{

}

// 名前修飾を設定
void SkeltonNameManglingWStringNode::SetSkeltonNameMangling( const char* pName, c16* pInstance, u32 size )
{
  m_Name = std::string( pName );
  m_pInstance = pInstance;
  m_Size = size;
...
// 値をテキストフォーマットで設定
b32 SkeltonNameManglingWStringNode::SetValue( const char* pValue )
{
  if( m_pInstance == NULL || m_Size <= 1 )
  {
    return false;
