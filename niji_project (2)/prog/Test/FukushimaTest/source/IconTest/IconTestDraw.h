...
#ifndef __TEST_FUKUSHIMA_ICON_TEST_DRAW_H_INCLUDED__
#define __TEST_FUKUSHIMA_ICON_TEST_DRAW_H_INCLUDED__
#pragma once
//======================================================================
/**
 * @file IconTestDraw.h
 * @date 2015/07/17 16:41:29
...
{
  GFL_FORBID_COPY_AND_ASSIGN( IconTestDraw );
...
public:
   ...
   */
  //------------------------------------------------------------------
  IconTestDraw( app::util::Heap* pHeap, app::util::AppRenderingManager* pAppRenderingManager );
...
public:
   ...
   */
  //------------------------------------------------------------------
  void SetTitleViewUIListener( Test::Fukushima::IconTestDrawListener* pListener );
...
private:
  ...
  Test::Fukushima::IconTestDrawListener*   m_uiListener;     //!< UIイベントリスナー
  ...
  //PokeIconTool*     m_pPokeIcon;

  app::tool::PokeIconToolEx*    m_pPokeIcon;

  gfl2::lyt::LytPicture*    m_pIconPane[6];
...
#endif // __TEST_FUKUSHIMA_ICON_TEST_DRAW_H_INCLUDED__
