...
{
  PANENAME_LOWER_PANE_BG_101,
  PANENAME_LOWER_PANE_BG_102,
  PANENAME_LOWER_PANE_BG_103,
  PANENAME_LOWER_PANE_BG_104,
};

static const u32 IconPaneTable[] =
{
  PANENAME_LOWER_PANE_ITEM_101,
  PANENAME_LOWER_PANE_ITEM_102,
  PANENAME_LOWER_PANE_ITEM_103,
  PANENAME_LOWER_PANE_ITEM_104,
};

static const u32 TextPaneTable[] =
{
  PANENAME_LOWER_PANE_TEXT_101,
  PANENAME_LOWER_PANE_TEXT_102,
  PANENAME_LOWER_PANE_TEXT_103,
  PANENAME_LOWER_PANE_TEXT_104,
};
 ...
 */
//-----------------------------------------------------------------------------
ListMiddle::ListMiddle( app::util::Heap * heap, app::util::G2DUtil * g2d, app::tool::ItemIcon * icon, app::tool::MenuCursor * cursor )
  : m_heap( heap )
  , m_g2dUtil( g2d )
  , m_itemIcon( icon )
  , m_menuCursor( cursor )
...
void ListMiddle::InitListData(void)
{
...
void ListMiddle::CreatePaneList(void)
{
  ...
  m_pNewPaneList->SetupTouchArea( 80, 159, 0, 320 );
  m_pNewPaneList->SetupInsertPane( param.lytwk->GetPane(PANENAME_LOWER_PANE_INSERT) );
  m_pNewPaneList->SetupNoLoop();
  m_pNewPaneList->SetupEffectMode( App::Tool::NewPaneList::EFFECT_MODE_COLOR );
...
void ListMiddle::DeletePaneList(void)
{
...
void ListMiddle::PaneListListener_Write( const App::Tool::NewPaneList::PANE_DATA * pane, u32 pane_index, u32 pos )
{
...
void ListMiddle::PaneListListener_MoveCursor( const App::Tool::NewPaneList::PANE_DATA * pane, u32 pane_index, u32 pos )
{
}

void ListMiddle::PaneListListener_Decide( u32 pos )
{
  GFL_PRINT( "★Decide -middle[%d]\n", pos );
}

void ListMiddle::PaneListListener_StartItemChange( const App::Tool::NewPaneList::PANE_DATA * pane, u32 pane_index, u32 pos )
{
}

void ListMiddle::PaneListListener_EndItemChange( const App::Tool::NewPaneList::PANE_DATA * pane, u32 pane_index, u32 pos1, u32 pos2 )
{
...
App::Tool::NewPaneList * ListMiddle::GetNewPaneList(void)
{
  return m_pNewPaneList;
}

app::tool::MenuCursor * ListMiddle::GetMenuCursor(void)
{
  return m_menuCursor;
}


void ListMiddle::UpdateItemIcon(void)
{
  for( u32 i=0; i<PANE_MAX; i++ )
  {
    ...
    {
    case 0:
      m_itemIcon->LoadRequest( i+10, m_itemIconReq[i] );
      m_itemIconLoad[i] = m_itemIconReq[i];
      m_itemIconSeq[i] = 1;
      /* FALL THROUGH */
    case 1:
      if( m_itemIcon->IsLoadFinished(i+10) == false )
      {
        break;
      }
      // 新しいリクエストが発行されていないか
      ...
      {
        m_itemIcon->ReplaceReadTexture( i+10, m_lytwk->GetPicturePane(IconPaneTable[i]) );
        m_itemIconReq[i] = ITEM_DUMMY_DATA;
      }
      m_itemIconSeq[i] = 0;
      break;
