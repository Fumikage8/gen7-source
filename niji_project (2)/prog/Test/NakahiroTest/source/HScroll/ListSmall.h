...
#if !defined( LIST_SMALL_H_INCLUDED )
#define LIST_SMALL_H_INCLUDED
...
public:
   ...
   */
  //-----------------------------------------------------------------------------
  ListSmall( app::util::Heap * heap, app::util::G2DUtil * g2d, app::tool::ItemIcon * icon, app::tool::MenuCursor * cursor );
