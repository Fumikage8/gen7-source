...
* @file   TakebeTestProc_Kisekae.h
* @author takebe_makoto
* @data   2015.04.14
*/
#if PM_DEBUG

#ifndef	__TAKEBE_TEST_PROC_KISEKAE_H_INCLUDE__
#define	__TAKEBE_TEST_PROC_KISEKAE_H_INCLUDE__
...
class TakebeTestProc_Kisekae : public GameSys::GameProc
{
public:
  ...
  * @return 無し
  */
  virtual ~TakebeTestProc_Kisekae( void );
