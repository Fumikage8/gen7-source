...
namespace {
  static u32 APP_SYS_HEAP_SIZE = 0x80000;
  static u32 APP_DEV_HEAP_SIZE = 0x800000;  // 8M
}
...
gfl2::proc::Result Proc::InitFunc(gfl2::proc::Manager* manager)
{
  if(m_Seq == 0)
  {
    ...
    {
      m_pManagerHeap = GFL_CREATE_LOCAL_HEAP_NAME( heap, 0x1000, gfl2::heap::HEAP_TYPE_EXP, false, "ImageDBTestManagerHeap" );
