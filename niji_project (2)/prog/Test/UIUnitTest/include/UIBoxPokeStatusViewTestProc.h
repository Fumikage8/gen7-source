...
#ifndef __UI_BOX_POKE_STATUS_VIEW_TEST_PROC_H__
#define __UI_BOX_POKE_STATUS_VIEW_TEST_PROC_H__
#pragma once
...
//  UIのBoxポケモンステータス表示のテスト
class UIBoxPokeStatusViewTestProc : public UIUnitTestBaseProc {
  GFL_FORBID_COPY_AND_ASSIGN(UIBoxPokeStatusViewTestProc); //コピーコンストラクタ＋代入禁止
public:
  UIBoxPokeStatusViewTestProc(void) : UIUnitTestBaseProc() {}
  virtual ~UIBoxPokeStatusViewTestProc(void) {}
...
#endif // __UI_BOX_POKE_STATUS_VIEW_TEST_PROC_H__
