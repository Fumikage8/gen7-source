...
public:
   ...
   */
  //------------------------------------------------------------------
  void   RegisterPokeMonsNameOrTamago( u32 bufID, const pml::pokepara::CoreParam* pp );
   ...
   */
  //------------------------------------------------------------------
  void   RegisterPokeMonsNameMsgData( u32 bufID, gfl2::str::MsgData* msgData, u32 strID );
   ...
   */
  //------------------------------------------------------------------
  void   RegisterPokeMonsNameStrBuf( u32 bufID, const gfl2::str::StrBuf* strBuf, u16 userParam );
   ...
   */
  //------------------------------------------------------------------
  void RegisterPlayerNickName( u32 bufID, const Savedata::MyStatus* status, const Savedata::FieldMenu* menu );
   ...
   *
   * @param   bufID         バッファID
   * @param   attractionId  アトラクション名
   */
  //------------------------------------------------------------------
  void RegisterAttractionName( u32 bufID, u32 attractionId );
   ...
   */
  //------------------------------------------------------------------
  void RegisterKisekaeItemName( u32 bufID, u32 itemID, u32 itemCount );
...
private:
  ...
  static const u16  REF_WORD_ID_NUM;   // 単複の文法特性を参照する
