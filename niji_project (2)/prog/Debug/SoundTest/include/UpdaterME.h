...
#if !defined __UPDATER_ME_H_INCLUDED__
#define __UPDATER_ME_H_INCLUDED__
#pragma once
...
GFL_NAMESPACE_BEGIN(sound)
   ...
   * @brief ME更新クラス
   */
  class UpdaterME : public UpdaterBase
  {
      GFL_FORBID_COPY_AND_ASSIGN(UpdaterME);
...
#endif // __UPDATER_ME_H_INCLUDED__
