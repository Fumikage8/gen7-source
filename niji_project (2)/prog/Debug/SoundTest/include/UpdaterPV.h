...
#if !defined __UPDATER_PV_H_INCLUDED__
#define __UPDATER_PV_H_INCLUDED__
#pragma once
...
GFL_NAMESPACE_BEGIN(sound)
   ...
   * @brief PV更新クラス
   */
  class UpdaterPV : public UpdaterBase
  {
    GFL_FORBID_COPY_AND_ASSIGN(UpdaterPV);
  ...
  public:
     ...
     */
    UpdaterPV(SetupParam &param, SoundContainer *pContainer);
  ...
  private:
    ...
    gfl2::str::StrBuf* m_pInfoStrBottomDev;  //!メッセージバッファ（下画面）
...
#endif // __UPDATER_PV_H_INCLUDED__
