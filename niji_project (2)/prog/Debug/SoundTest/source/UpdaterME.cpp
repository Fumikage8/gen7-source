 ...
 */
UpdaterME::UpdaterME(SetupParam &param)
: UpdaterBase(param)
{
 ...
 * @brief Aボタン押下時の処理
 */
void UpdaterME::FuncButtonA(void)
{
 ...
 * @brief 右キー押下時の処理
 */
void UpdaterME::FuncKeyRight(void)
{
  ChangeDispInfo();
}
 ...
 * @brief 左キー押下時の処理
 */
void UpdaterME::FuncKeyLeft(void)
{
  ChangeDispInfo();
}
 ...
 * @param y Ｙ座標
 */
void UpdaterME::FuncTouch(int x, int y)
{
 ...
 * @brief ページ変更時処理
 */
void UpdaterME::ChangePageFunc(void)
{
  m_pDebugMsg->GetString(	msg_dmenu_sound_test_ME, *m_pStr );
 ...
 */
void UpdaterME::DrawTop(gfl2::util::DrawUtilText* pDrawUtilText)
{
 ...
 * @param pDrawUtilText  テキストユーティリティクラスへのポインタ
 */
void UpdaterME::DrawBottom(gfl2::util::DrawUtilText* pDrawUtilText)
{
  pDrawUtilText->SetTextColor( gfl2::math::Vector4( 1.0f, 1.0f, 1.0f, 1.0f ) );
 ...
 * @brief 表示情報の変更
 */
void UpdaterME::ChangeDispInfo(void)
{
