 ...
 */
//-----------------------------------------------------------------------------
PokeIconViewProc::PokeIconViewProc(void)
{
}
 ...
 */
//-----------------------------------------------------------------------------
PokeIconViewProc::~PokeIconViewProc()
{
}
 ...
 */
//-----------------------------------------------------------------------------
gfl2::proc::Result PokeIconViewProc::InitFunc( gfl2::proc::Manager * pManager )
{
  switch( GetSubSeq() )
  {
  case 0:
 ...
 */
//-----------------------------------------------------------------------------
gfl2::proc::Result PokeIconViewProc::EndFunc( gfl2::proc::Manager * pManager )
{
  switch( GetSubSeq() )
  {
  case 0:
 ...
 */
//-----------------------------------------------------------------------------
gfl2::proc::Result PokeIconViewProc::UpdateFunc( gfl2::proc::Manager * pManager )
{
 ...
 */
//-----------------------------------------------------------------------------
void PokeIconViewProc::PreDrawFunc( gfl2::proc::Manager * pManager )
{
 ...
 */
//-----------------------------------------------------------------------------
void PokeIconViewProc::DrawFunc( gfl2::proc::Manager * pManager, gfl2::gfx::CtrDisplayNo displayNo )
{
 ...
 */
//-----------------------------------------------------------------------------
void PokeIconViewProc::CreateHeap(void)
{
 ...
 */
//-----------------------------------------------------------------------------
void PokeIconViewProc::DeleteHeap(void)
{
  // ローカルヒープ削除
  m_heap.Delete();
  // マネージャヒープ削除
 ...
 */
//-----------------------------------------------------------------------------
void PokeIconViewProc::CreateRenderManager(void)
{
 ...
 */
//-----------------------------------------------------------------------------
bool PokeIconViewProc::DeleteRenderManager(void)
{
 ...
 */
//-----------------------------------------------------------------------------
void PokeIconViewProc::CreateFrame(void)
{
  m_pFrameManager = GFL_NEW(m_pManagerHeap) applib::frame::Manager( m_pManagerHeap );
  m_pFrame = MENU_FRAME_CALL_MODAL< applib::frame::Manager, PokeIconViewFrame >( m_pFrameManager );
  m_pFrame->Setup( &m_heap, m_pRenderingManager );
}
 ...
 */
//-----------------------------------------------------------------------------
bool PokeIconViewProc::DeleteFrame(void)
{
