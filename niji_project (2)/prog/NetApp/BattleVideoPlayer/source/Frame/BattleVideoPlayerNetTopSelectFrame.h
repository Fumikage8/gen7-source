 ...
 */
//=============================================================================
#ifndef BATTLE_VIDEO_PLAYER_NET_TOP_SELECT_FRAME_H_INCLUDED
#define BATTLE_VIDEO_PLAYER_NET_TOP_SELECT_FRAME_H_INCLUDED
#pragma once
...
GFL_NAMESPACE_BEGIN( BattleVideoPlayer )
  ...
  public:
    enum Result
    {
      RESULT_NONE  = 0,
      RESULT_CANCEL,
      RESULT_SELECT_VIDEO_SEARCH,
      RESULT_SELECT_VIDEO_PUBLIC,
    };
...
#endif // BATTLE_VIDEO_PLAYER_NET_TOP_SELECT_FRAME_H_INCLUDED
