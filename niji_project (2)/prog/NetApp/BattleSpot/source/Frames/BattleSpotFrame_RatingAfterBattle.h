#if !defined(BATTLESPOTFRAME_RATINGAFTERBATTLE_H_INCLUDED)
#define BATTLESPOTFRAME_RATINGAFTERBATTLE_H_INCLUDED
#pragma once
//==============================================================================
/**
 * @file   BattleSpotFrame_RatingAfterBattle.h
...
{
  GFL_FORBID_COPY_AND_ASSIGN( Frame_RatingAfterBattle );

public:
  Frame_RatingAfterBattle(BattleSpotWork* pWork);
  virtual ~Frame_RatingAfterBattle();
...
#endif  /*  #if !defined(BATTLESPOTFRAME_RATINGAFTERBATTLE_H_INCLUDED)  */
