#if !defined(BATTLESPOTFRAME_FRIENDAFTERBATTLE_H_INCLUDED)
#define BATTLESPOTFRAME_FRIENDAFTERBATTLE_H_INCLUDED
#pragma once
//==============================================================================
/**
 * @file   BattleSpotFrame_FriendAfterBattle.h
...
/**
  ...
  */
//==============================================================================
class Frame_FriendAfterBattle
  : public    NetAppLib::System::NetAppFrameBase
  , protected LowerView_Selection::IEventHandler
{
  GFL_FORBID_COPY_AND_ASSIGN( Frame_FriendAfterBattle );

public:
  Frame_FriendAfterBattle(BattleSpotWork* pWork);
  virtual ~Frame_FriendAfterBattle();
