#if !defined(BATTLESPOTFRAME_FRIENDBATTLEMATCHING_H_INCLUDED)
#define BATTLESPOTFRAME_FRIENDBATTLEMATCHING_H_INCLUDED
#pragma once
//==============================================================================
/**
 * @file   BattleSpotFrame_FriendBattleMatching.h
...
/**
  ...
  */
//==============================================================================
class Frame_FriendBattleMatching
...
{
  GFL_FORBID_COPY_AND_ASSIGN( Frame_FriendBattleMatching );
public:
...
public:
  Frame_FriendBattleMatching(BattleSpotWork* pWork);
  virtual ~Frame_FriendBattleMatching();
