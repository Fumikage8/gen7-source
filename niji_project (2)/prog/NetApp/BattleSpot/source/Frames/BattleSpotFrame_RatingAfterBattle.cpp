//==============================================================================
/**
 * @file   BattleSpotFrame_RatingAfterBattle.cpp
...
#include  "./BattleSpotFrame_RatingAfterBattle.h"
...
//------------------------------------------------------------------
/**
  *  @func     Frame_RatingAfterBattle
  *  @brief    ctor
  */
//------------------------------------------------------------------
Frame_RatingAfterBattle::Frame_RatingAfterBattle(BattleSpotWork* pWork)
...
/**
  ...
  */
//------------------------------------------------------------------
Frame_RatingAfterBattle::~Frame_RatingAfterBattle()
{
...
/**
  ...
  */
//------------------------------------------------------------------
bool  Frame_RatingAfterBattle::startup()
{
...
//    m_pUpperView  = m_pViewContainer->m_pUpperView_Demo;
  ...
  {//選択
    ...
    m_pLowerView->SetViewMode(LowerView_Selection::VIEWMODE_Message_ContinueConfirmRate);
...
/**
  ...
  */
//------------------------------------------------------------------
void  Frame_RatingAfterBattle::setListener()
{
...
/**
  ...
  */
//------------------------------------------------------------------
void  Frame_RatingAfterBattle::removeListener()
{
...
/**
  ...
  */
//------------------------------------------------------------------
void  Frame_RatingAfterBattle::updateSequence()
{
  switch(m_State)
  {
    case  STATE_Entry:
    ...
    case STATE_Dissconnect:
      {
        if( DisconnectWait() )
        {
          ...
          ExitSelf(RESULE_RatingAfterBattle_BattleVideo);
        }
      }
    break;
...
/**
  ...
  */
//------------------------------------------------------------------
bool  Frame_RatingAfterBattle::cleanup()
{
  bool  bAllDone = false;
...
void  Frame_RatingAfterBattle::LowerView_Selection_OnEvent(LowerView_Selection* pSender, const LowerView_Selection::IEventHandler::EventCode eventCode)
{
  switch(eventCode)
  {
    case  LowerView_Selection::IEventHandler::EVENT_Continue_Next:             
      {
        ExitSelf(RESULT_RatingAfterBattle_Next);
      }
    break;
    case  LowerView_Selection::IEventHandler::EVENT_Continue_Change:             
      {
        ...
        ExitSelf(RESULT_RatingAfterBattle_Change);
      }
    break;
    case  LowerView_Selection::IEventHandler::EVENT_Continue_Exit:             
      {
        ExitSelf(RESULT_RatingAfterBattle_Exit);
      }
    break;
  }
}
...
/**
  ...
  */
//------------------------------------------------------------------
void  Frame_RatingAfterBattle::ExitSelf(const FrameResult frameResult)
{
...
bool Frame_RatingAfterBattle::DisconnectWait()
{
#if defined(GF_PLATFORM_CTR)
...
void Frame_RatingAfterBattle::UpdateRankData()
{
#if defined(GF_PLATFORM_CTR)
...
void Frame_RatingAfterBattle::SendBattleVideo()
{
#if defined(GF_PLATFORM_CTR)
...
/**
  ...
  */
//--------------------------------------------------------------------------------------------
void Frame_RatingAfterBattle::OnError( BattleVideoResponseListener::ERROR_TYPE errorType )
{
  m_State = STATE_UpdateRank;
}
...
/**
  ...
  */
//--------------------------------------------------------------------------------------------
void Frame_RatingAfterBattle::OnUploadSuccess( void )
{
  m_State = STATE_UpdateRank;
}
...
/**
  ...
  */
//--------------------------------------------------------------------------------------------
void Frame_RatingAfterBattle::OnUploadInvalid( void )
{
  m_State = STATE_UpdateRank;
}
