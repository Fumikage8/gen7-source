#if !defined(BATTLESPOTFRAME_INTERNETBATTLEMATCHING_H_INCLUDED)
#define BATTLESPOTFRAME_INTERNETBATTLEMATCHING_H_INCLUDED
#pragma once
//==============================================================================
/**
 * @file   BattleSpotFrame_InternetBattleMatching.h
...
/**
  ...
  */
//==============================================================================
class Frame_InternetBattleMatching
...
{
  GFL_FORBID_COPY_AND_ASSIGN( Frame_InternetBattleMatching );
public:
...
public:
  Frame_InternetBattleMatching(BattleSpotWork* pWork);
  virtual ~Frame_InternetBattleMatching();
...
#endif  /*  #if !defined(BATTLESPOTFRAME_INTERNETBATTLEMATCHING_H_INCLUDED)  */
