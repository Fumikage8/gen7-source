// ============================================================================
/*
 * @file GTSSearchPokemonLowerView.cpp
...
static const u32 buttonPartsPaneIDTable[] =
{
  ...
  PANENAME_GTS_SLC_LOW_000_PANE_BTNS_03,
};
...
GTSSearchPokemonLowerView::GTSSearchPokemonLowerView( NetApp::GTS::ApplicationSystem::GTSWork* pGTSWork ) :
  NetApp::GTS::ViewBase::GTSSlcLowerViewBase( pGTSWork ),
  m_pGTSWork( pGTSWork ),
  m_pSearchPokemonDrawListener( NULL ),
...
GTSSearchPokemonLowerView::~GTSSearchPokemonLowerView()
{
  ReleaseCursor();
}


void GTSSearchPokemonLowerView::setupTextMessage()
{
  // 下画面のTextを置き換え
  {
    ...
    setupLayout( LAYOUT_WORK_ID_LOWER, LA_GTS_GTS_SLC_LOW_000_PATERN_07 );
    ...
    // 画面上のテキスト
    {
      ...
      pG2DUtil->SetTextBoxPaneStringExpand( pTextBox, msg_gts_sys_cap_01 );
    }
    ...
    // 『この条件で探す』ボタン
    {
      ...
      pG2DUtil->SetTextBoxPaneStringExpand( pTextBox_00, msg_gts_sel_09 );
    }

    // 『オプション』ボタン
    {
      gfl2::lyt::LytParts* pBtnS_03 = pLower->GetPartsPane( PANENAME_GTS_SLC_LOW_000_PANE_BTNS_03 );
      gfl2::lyt::LytTextBox* pTextBox_00 = pLower->GetTextBoxPane( pBtnS_03, PANENAME_GTS_BTN_LOW_001_PANE_TEXTBOX_00, &gtsResourceID );
      pG2DUtil->SetTextBoxPaneStringExpand( pTextBox_00, msg_gts_sel_08 );
    }
  }
}


void GTSSearchPokemonLowerView::setupButton()
{
  app::ui::ButtonInfoEx buttonInfoTable[] =
  {
    ...
    {
      BUTTON_ID_BTNS_03, NULL, NULL,
      LA_GTS_GTS_SLC_LOW_000__BTNS_03_TOUCH,
      LA_GTS_GTS_SLC_LOW_000__BTNS_03_RELEASE,
      LA_GTS_GTS_SLC_LOW_000__BTNS_03_CANSEL,
      LA_GTS_GTS_SLC_LOW_000__BTNS_03_TOUCH_RELEASE,
      LA_GTS_GTS_SLC_LOW_000__BTNS_03_ACTIVE,
      LA_GTS_GTS_SLC_LOW_000__BTNS_03_PASSIVE,
    },
  };
...

  {
    ...
    buttonInfoTable[ BUTTON_ID_BTNS_03 ].picture_pane = pBtnS03;
    buttonInfoTable[ BUTTON_ID_BTNS_03 ].bound_pane = pLower->GetBoundingPane( pBtnS03, PANENAME_GTS_BTN_LOW_001_PANE_BOUND_00, &gtsResourceID );
  }
  ...
  pButtonManager->SetButtonSelectSE( BUTTON_ID_BTNS_03,   SEQ_SE_DECIDE1 );
...
// UIView
//-----------------------------------------------------------------------------
void GTSSearchPokemonLowerView::OnAddChild()
{
  SetCursorVisible( false );
}


void GTSSearchPokemonLowerView::OnAddedToParent()
{
  SetCursorVisible( true );
}


void GTSSearchPokemonLowerView::OnRemoveChild()
{
  SetCursorVisible( true );
}


void GTSSearchPokemonLowerView::OnRemovedFromParent()
{
  SetCursorVisible( false );
}


void GTSSearchPokemonLowerView::Update()
{
  NetApp::GTS::ViewBase::GTSSlcLowerViewBase::Update();
}


void GTSSearchPokemonLowerView::Draw( gfl2::gfx::CtrDisplayNo displayNo )
{
  app::util::G2DUtil* pG2DUtil = UIView::GetG2DUtil();
...
// UIInputListener
//-----------------------------------------------------------------------------
::app::ui::UIInputListener::ListenerResult GTSSearchPokemonLowerView::OnLayoutPaneEvent( const u32 painId )
{
  ...
  switch( painId )
  {
    ...
    {
      if( m_pSearchPokemonDrawListener )
      {
        m_pSearchPokemonDrawListener->TouchBackButton();
      }
    ...
    case BUTTON_ID_BTNM_00:
    {
      if( m_pSearchPokemonDrawListener )
      {
        m_pSearchPokemonDrawListener->TouchPokemonButton();
      }
      result = DISABLE_ACCESS;
    }
    break;
    ...
    case BUTTON_ID_BTNM_01:
    {
      if( m_pSearchPokemonDrawListener )
      {
        m_pSearchPokemonDrawListener->TouchGenderButton();
      }
      result = DISABLE_ACCESS;
    }
    break;
    ...
    case BUTTON_ID_BTNM_02:
    {
      if( m_pSearchPokemonDrawListener )
      {
        m_pSearchPokemonDrawListener->TouchLevelButton();
      }
      result = DISABLE_ACCESS;
    }
    break;
    ...
    case BUTTON_ID_BTN_GREEN:
    {
      if( m_pSearchPokemonDrawListener )
      {
        m_pSearchPokemonDrawListener->TouchSearchButton();
      }
      result = DISABLE_ACCESS;
    }
    break;
    ...
    //『オプション』ボタン
    case BUTTON_ID_BTNS_03:
    {
      if( m_pSearchPokemonDrawListener )
      {
        m_pSearchPokemonDrawListener->TouchOptionButton();
      }
      result = DISABLE_ACCESS;
    }
    break;
...
void GTSSearchPokemonLowerView::SetPokemonName( gfl2::str::StrBuf& inputName )
{
  app::util::G2DUtil* pG2DUtil = UIView::GetG2DUtil();
  gfl2::lyt::LytMultiResID gtsResourceID = pG2DUtil->GetLayoutResourceID( LAYOUT_RESOURCE_ID_GTS );
  gfl2::lyt::LytWk* pLower = pG2DUtil->GetLayoutWork( LAYOUT_WORK_ID_LOWER );
...
void GTSSearchPokemonLowerView::SetPokemon( u32 messageID )
{
  app::util::G2DUtil* pG2DUtil = UIView::GetG2DUtil();
  gfl2::lyt::LytMultiResID gtsResourceID = pG2DUtil->GetLayoutResourceID( LAYOUT_RESOURCE_ID_GTS );
  gfl2::lyt::LytWk* pLower = pG2DUtil->GetLayoutWork( LAYOUT_WORK_ID_LOWER );
...
void GTSSearchPokemonLowerView::SetGender( u32 messageID )
{
  app::util::G2DUtil* pG2DUtil = UIView::GetG2DUtil();
  gfl2::lyt::LytMultiResID gtsResourceID = pG2DUtil->GetLayoutResourceID( LAYOUT_RESOURCE_ID_GTS );
  gfl2::lyt::LytWk* pLower = pG2DUtil->GetLayoutWork( LAYOUT_WORK_ID_LOWER );
...
void GTSSearchPokemonLowerView::SetLevelBand( u32 messageID )
{
  app::util::G2DUtil* pG2DUtil = UIView::GetG2DUtil();
  gfl2::lyt::LytMultiResID gtsResourceID = pG2DUtil->GetLayoutResourceID( LAYOUT_RESOURCE_ID_GTS );
  gfl2::lyt::LytWk* pLower = pG2DUtil->GetLayoutWork( LAYOUT_WORK_ID_LOWER );
...
void GTSSearchPokemonLowerView::SetGenderButtonSE( bool bEnableSelectGender )
{
  app::tool::ButtonManager* pButtonManager = GetButtonManager();
