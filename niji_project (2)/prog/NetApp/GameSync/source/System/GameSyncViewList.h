// ============================================================================
/*
 * @file GameSyncViewList.h
 * @brief ゲームシンクアプリのViewリストです。
 * @date 2015.11.24
 * @author endo_akira
 */
// ============================================================================
#if !defined( GAMESYNC_VIEWLIST_H_INCLUDE )
#define GAMESYNC_VIEWLIST_H_INCLUDE
#pragma once
...
{
  GFL_FORBID_COPY_AND_ASSIGN( GameSyncViewList );

public:

  GameSyncViewList( app::util::Heap* pAppHeap );
  virtual~GameSyncViewList();
...
#endif // GAMESYNC_VIEWLIST_H_INCLUDE
