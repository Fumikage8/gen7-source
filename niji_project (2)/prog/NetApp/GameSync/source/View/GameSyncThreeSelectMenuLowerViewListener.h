// ============================================================================
/*
 * @file GameSyncThreeSelectMenuLowerViewListener.h
 * @brief ゲームシンクアプリの下画面の入力イベントを受け取るリスナーです。
 * @date 2015.11.24
 * @author endo_akira
 */
// ============================================================================
#if !defined( GAMESYNCTHREESELECTMENULOWERVIEWLISTENER_H_INCLUDE )
#define GAMESYNCTHREESELECTMENULOWERVIEWLISTENER_H_INCLUDE
#pragma once
...
class GameSyncThreeSelectMenuLowerViewListener : public NetAppLib::System::NetAppViewListenerBase
{
public:

  GameSyncThreeSelectMenuLowerViewListener() :
...
#endif // GAMESYNCTHREESELECTMENULOWERVIEWLISTENER_H_INCLUDE
