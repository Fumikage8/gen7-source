// ============================================================================
/*
 * @file GameSyncLowCaptureUpperView.cpp
...
GameSyncLowCaptureUpperView::GameSyncLowCaptureUpperView( NetApp::GameSync::System::GameSyncWork* pGameSyncWork ) :
  ...
  m_pGameSyncWork( pGameSyncWork )
{
  ...
  UIView::GetG2DUtil()->StartAnime( LAYOUT_WORK_ID_UPPER, LA_GAMESYNC_GAMESYNC_SAMPLEPIC_UP_000_PATERN_01 );
}


GameSyncLowCaptureUpperView::~GameSyncLowCaptureUpperView()
{
}


void GameSyncLowCaptureUpperView::ChangeLayout( u32 animeID )
{
  UIView::GetG2DUtil()->StartAnime( LAYOUT_WORK_ID_UPPER, animeID );
}


void GameSyncLowCaptureUpperView::Draw( gfl2::gfx::CtrDisplayNo displayNo )
{
