...
//==============================================================================
/**
 * @file   EvolutionProc.cpp
 * @date   2015/08/28 Fri. 17:21:27
 * @author muto_yu
 * @brief  
 * @par Copyright
...
#include  "./System/EvolutionApplicationSystem.h"
#include  "./System/EvolutionBuilder.h"
#include  "./EvolutionFrameDef.h"
#include  "../include/EvolutionProc.h"
...
/**
  ...
  */
//------------------------------------------------------------------
EvolutionProc::EvolutionProc( APP_PARAM* pAppParam )
  : GameSys::GameProc()
...
/**
  ...
  */
//------------------------------------------------------------------
gfl2::proc::Result  EvolutionProc::InitFunc( gfl2::proc::Manager* pProcManager )
{
  ...
  switch(GetSubSeq())
  {
    case  SUBSEQ_INIT_Initial:
      /*  applicationSystem  */
      m_pWork = GFL_NEW(pHeapBase)  EvolutionWork();
      m_pWork->m_pAppParam = m_pAppParam;
      {
        const FrameID       firstFrame  = GetFirstFrameID();   /*  最初のFrame  */
        EvolutionBuilder    builder( m_pWork, firstFrame );
...
/**
  ...
  */
//------------------------------------------------------------------
gfl2::proc::Result EvolutionProc::EndFunc( gfl2::proc::Manager* pProcManager )
{
  gfl2::proc::Result  result  = gfl2::proc::RES_CONTINUE;
...
/**
  ...
  */
//------------------------------------------------------------------
gfl2::proc::Result EvolutionProc::UpdateFunc( gfl2::proc::Manager* pProcManager )
{
  gfl2::proc::Result  result  = gfl2::proc::RES_CONTINUE;
...
/**
  ...
  */
//------------------------------------------------------------------
void  EvolutionProc::PreDrawFunc( gfl2::proc::Manager* pProcManager )
{
...
/**
  ...
  */
//------------------------------------------------------------------
void  EvolutionProc::DrawFunc( gfl2::proc::Manager* pProcManager, gfl2::gfx::CtrDisplayNo displayNo )
{
//  GFL_PRINT("%s\n", __FUNCTION__);
/*
...
/**
  ...
  */
//------------------------------------------------------------------
FrameID EvolutionProc::GetFirstFrameID(void) const
{
