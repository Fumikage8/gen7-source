//==============================================================================
/**
 * @file   IDCardParts_UpperMain.cpp
 * @date   2015/07/16 Thu. 18:21:22
 * @author muto_yu
...
/**
  ...
  */
//------------------------------------------------------------------
PokemonParts_UpperMain::PokemonParts_UpperMain(LiveWork* pWork)
...
/**
  ...
  */
//------------------------------------------------------------------
PokemonParts_UpperMain::~PokemonParts_UpperMain()
{
}
...
/**
  ...
  */
//------------------------------------------------------------------
void  PokemonParts_UpperMain::Setup(const u32 slotIndex, app::util::G2DUtil* pG2DUtil, u32 lytID, const u32 layoutMultiResourceID)
{
  const struct PaneIDTableInfo
  {
    ...
    {PANENAME_LIVE_PLT_000_PANE_POKE_00, PANENAME_LIVE_PLT_000_PANE_POKE_00, LA_LIVE_LIVE_MIN_UPP_000__IDCARD__GENDER_00_ICON_MALE, LA_LIVE_LIVE_MIN_UPP_000__IDCARD__GENDER_00_ICON_FEMALE},
    {PANENAME_LIVE_PLT_000_PANE_POKE_01, PANENAME_LIVE_PLT_000_PANE_POKE_01, LA_LIVE_LIVE_MIN_UPP_000__IDCARD__GENDER_01_ICON_MALE, LA_LIVE_LIVE_MIN_UPP_000__IDCARD__GENDER_01_ICON_FEMALE},
    {PANENAME_LIVE_PLT_000_PANE_POKE_02, PANENAME_LIVE_PLT_000_PANE_POKE_02, LA_LIVE_LIVE_MIN_UPP_000__IDCARD__GENDER_02_ICON_MALE, LA_LIVE_LIVE_MIN_UPP_000__IDCARD__GENDER_02_ICON_FEMALE},
    {PANENAME_LIVE_PLT_000_PANE_POKE_03, PANENAME_LIVE_PLT_000_PANE_POKE_03, LA_LIVE_LIVE_MIN_UPP_000__IDCARD__GENDER_03_ICON_MALE, LA_LIVE_LIVE_MIN_UPP_000__IDCARD__GENDER_03_ICON_FEMALE},
    {PANENAME_LIVE_PLT_000_PANE_POKE_04, PANENAME_LIVE_PLT_000_PANE_POKE_04, LA_LIVE_LIVE_MIN_UPP_000__IDCARD__GENDER_04_ICON_MALE, LA_LIVE_LIVE_MIN_UPP_000__IDCARD__GENDER_04_ICON_FEMALE},
    {PANENAME_LIVE_PLT_000_PANE_POKE_05, PANENAME_LIVE_PLT_000_PANE_POKE_05, LA_LIVE_LIVE_MIN_UPP_000__IDCARD__GENDER_05_ICON_MALE, LA_LIVE_LIVE_MIN_UPP_000__IDCARD__GENDER_05_ICON_FEMALE},
  };
  ...
  helper.Push(PANENAME_LIVE_MIN_UPP_000_PANE_IDCARD);
...
/**
  ...
  */
//------------------------------------------------------------------
IDCardParts_UpperMain::IDCardParts_UpperMain(LiveWork* pWork)
...
/**
  ...
  */
//------------------------------------------------------------------
IDCardParts_UpperMain::~IDCardParts_UpperMain()
{
}
...
/**
  ...
  */
//------------------------------------------------------------------
void  IDCardParts_UpperMain::Setup(app::util::G2DUtil* pG2DUtil, u32 lytID, const u32 layoutMultiResourceID)
{
...
//    m_TextBoxes[TEXTBOX_PlayersRecord] = helper.GetTextBoxPane(PANENAME_LIVE_PLT_000_PANE_TEXTBOX_00);         /*  【msg_lt_sys_06】「プレイヤー名」の　せいせき */
  ...
  {
    m_pPokemonParts[num]  = GFL_NEW(pHeapBase) PokemonParts_UpperMain(m_pWork);  /*  解体は基底のdtor  */
