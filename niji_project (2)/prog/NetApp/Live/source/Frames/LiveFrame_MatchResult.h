...
#if !defined(LIVEFRAME_MATCHRESULT_H_INCLUDED)
#define LIVEFRAME_MATCHRESULT_H_INCLUDED
#pragma once
//==============================================================================
/**
 * @file   LiveFrame_MatchResult.h
 * @date   2015/07/28 Tue. 14:54:14
 * @author muto_yu
 * @brief  
 * @par Copyright
...
{
  GFL_FORBID_COPY_AND_ASSIGN( Frame_MatchResult );
...
public:
  ...
  /**
    ...
    */
  //------------------------------------------------------------------
  Frame_MatchResult(LiveWork* pWork);
...
private:
  ...
  */
  ...
  void  BattleRecorderDataSaveResultHandling(const ExtSavedata::BattleRecorderSaveData::Result saveResult);
  void  ExitFrame(const FrameResult = RESULT_MATCHRESULT_Exit);
...
#endif  /*  #if !defined(LIVEFRAME_MATCHRESULT_H_INCLUDED)  */
