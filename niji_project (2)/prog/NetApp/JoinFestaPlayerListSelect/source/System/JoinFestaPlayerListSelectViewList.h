// ============================================================================
/*
 * @file JoinFestaPlayerListSelectViewList.h
 * @brief プレイヤー単体選択アプリのViewリストです。
 * @date 2015.10.19
 * @author endo_akira
 */
// ============================================================================
#if !defined( JOINFESTAPLAYERLISTSELECT_VIEWLIST_H_INCLUDE )
#define JOINFESTAPLAYERLISTSELECT_VIEWLIST_H_INCLUDE
#pragma once
...
{
  GFL_FORBID_COPY_AND_ASSIGN( JoinFestaPlayerListSelectViewList );

public:

  JoinFestaPlayerListSelectViewList( app::util::Heap* pAppHeap );
  virtual~JoinFestaPlayerListSelectViewList();
...
#endif // JOINFESTAPLAYERLISTSELECT_VIEWLIST_H_INCLUDE
