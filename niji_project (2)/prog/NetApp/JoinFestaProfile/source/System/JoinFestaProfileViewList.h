// ============================================================================
/*
 * @file JoinFestaProfileViewList.h
 * @brief プロフィールアプリのViewリストです。
 * @date 2015.10.26
 * @author endo_akira
 */
// ============================================================================
#if !defined( JOINFESTAPROFILE_VIEWLIST_H_INCLUDE )
#define JOINFESTAPROFILE_VIEWLIST_H_INCLUDE
#pragma once
...
{
  GFL_FORBID_COPY_AND_ASSIGN( JoinFestaProfileViewList );

public:

  JoinFestaProfileViewList( app::util::Heap* pAppHeap );
  virtual~JoinFestaProfileViewList();
...
#endif // JOINFESTAPROFILE_VIEWLIST_H_INCLUDE
