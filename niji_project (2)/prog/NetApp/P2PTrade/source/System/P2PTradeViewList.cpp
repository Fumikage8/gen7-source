...
P2PTradeViewList::P2PTradeViewList( app::util::Heap* pAppHeap ) :
...
P2PTradeViewList::~P2PTradeViewList()
{
...
void P2PTradeViewList::Draw( gfl2::gfx::CtrDisplayNo displayNo )
{
...
void P2PTradeViewList::AddUpperView( NetAppLib::System::NetApplicationViewBase* pView )
{
...
void P2PTradeViewList::AddLowerView( NetAppLib::System::NetApplicationViewBase* pView )
{
...
void P2PTradeViewList::AddUpperViewInputEnable( NetAppLib::System::NetApplicationViewBase* pView )
{
  m_pActiveUpperView->AddSubView( pView );
  m_pActiveUpperView = pView;
...
void P2PTradeViewList::AddLowerViewInputEnable( NetAppLib::System::NetApplicationViewBase* pView )
{
  m_pActiveLowerView->AddSubView( pView );
  m_pActiveLowerView = pView;
  pView->SetInputEnabled( true );
...
void P2PTradeViewList::AddUpperViewInputDisable( NetAppLib::System::NetApplicationViewBase* pView )
{
  m_pActiveUpperView->AddSubView( pView );
  m_pActiveUpperView = pView;
...
void P2PTradeViewList::AddLowerViewInputDisable( NetAppLib::System::NetApplicationViewBase* pView )
{
  m_pActiveLowerView->AddSubView( pView );
  m_pActiveLowerView = pView;
  pView->SetInputEnabled( false );
...
void P2PTradeViewList::RemoveUpperView()
{
...
void P2PTradeViewList::RemoveLowerView()
{
...
void P2PTradeViewList::RemoveAllView()
{
