// ============================================================================
/*
 * @file P2PTradeViewList.h
 * @brief P2P交換アプリのViewリストです。
 * @date 2015.10.28
 * @author endo_akira
 */
// ============================================================================
#if !defined( P2PTRADE_VIEWLIST_H_INCLUDE )
#define P2PTRADE_VIEWLIST_H_INCLUDE
#pragma once
...
{
  GFL_FORBID_COPY_AND_ASSIGN( P2PTradeViewList );

public:

  P2PTradeViewList( app::util::Heap* pAppHeap );
  virtual~P2PTradeViewList();
...
#endif // P2PTRADE_VIEWLIST_H_INCLUDE
