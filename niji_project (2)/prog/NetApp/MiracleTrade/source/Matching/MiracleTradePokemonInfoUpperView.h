// ============================================================================
/*
 * @file MiracleTradePokemonInfoUpperView.h
 * @brief ミラクル交換のポケモン情報を表示するクラスです。
 * @date 2015.05.25
 */
// ============================================================================
#if !defined( MIRACLETRADEPOKEMONINFOUPPERVIEW_H_INCLUDE )
#define MIRACLETRADEPOKEMONINFOUPPERVIEW_H_INCLUDE
#pragma once
...
{
  GFL_FORBID_COPY_AND_ASSIGN( MiracleTradePokemonInfoUpperView );
public:
  MiracleTradePokemonInfoUpperView( NetApp::MiracleTrade::ApplicationSystem::MiracleTradeWork* pMiracleTradeWork );
  virtual~MiracleTradePokemonInfoUpperView();
...
#endif // MIRACLETRADEPOKEMONINFOUPPERVIEW_H_INCLUDE
