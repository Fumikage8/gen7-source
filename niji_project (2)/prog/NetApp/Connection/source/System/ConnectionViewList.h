// ============================================================================
/*
 * @file ConnectionViewList.h
 * @brief インターネット接続アプリのViewリストです。
 * @date 2015.08.20
 * @author endo_akira
 */
// ============================================================================
#if !defined( CONNECTION_VIEWLIST_H_INCLUDE )
#define CONNECTION_VIEWLIST_H_INCLUDE
#pragma once
...
{
  GFL_FORBID_COPY_AND_ASSIGN( ConnectionViewList );

public:

  ConnectionViewList( app::util::Heap* pAppHeap );
  virtual~ConnectionViewList();
...
#endif // CONNECTION_VIEWLIST_H_INCLUDE
