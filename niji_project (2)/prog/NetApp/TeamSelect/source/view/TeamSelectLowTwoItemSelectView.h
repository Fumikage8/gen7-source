//======================================================================
/**
 * @file TeamSelectLowTwoItemSelectView.h
...
#if !defined __TEAM_SELECT_LOW_TWO_ITEM_SELECT_VIEW_H_INCLUDED__
#define __TEAM_SELECT_LOW_TWO_ITEM_SELECT_VIEW_H_INCLUDED__
#pragma once
...
GFL_NAMESPACE_BEGIN(TeamSelect)
  ...
  /**
   * @class TeamSelectLowTwoItemSelectView
   */
  class TeamSelectLowTwoItemSelectView : public app::ui::UIView, public app::ui::UIInputListener
  {
      GFL_FORBID_COPY_AND_ASSIGN(TeamSelectLowTwoItemSelectView);
  ...
  public:
    ...
    /**
      ...
      */
    //------------------------------------------------------------------
    TeamSelectLowTwoItemSelectView( app::util::Heap* pHeap, app::util::AppRenderingManager* pRenderManager );

    virtual ~TeamSelectLowTwoItemSelectView();
    ...
    */
    ...
    /**
      ...
      */
    //------------------------------------------------------------------
    void SetCursorPos( const ButtonId btnId );
    ...
    /**
      ...
      */
    //------------------------------------------------------------------
    void SetTextBtn( const ButtonId btnId, const u32 msgId );
...
#endif // __TEAM_SELECT_LOW_TWO_ITEM_SELECT_VIEW_H_INCLUDED__