// ============================================================================
/*
 * @file RegulationSelectLoadFrame.cpp
...
RegulationSelectLoadFrame::RegulationSelectLoadFrame(
...
//-----------------------------------------------------------------------------
bool RegulationSelectLoadFrame::startup()
{
  ...
  loadRegulationData( true );

  return true;
}


void RegulationSelectLoadFrame::setListener()
{
...
void RegulationSelectLoadFrame::removeListener()
{
...
void RegulationSelectLoadFrame::updateSequence()
{
  switch( m_RegulationSelectMessageMenuLowerViewListener.GetInputEventID() )
  {
    case NetApp::RegulationSelect::Draw::RegulationSelectMessageMenuLowerViewListener::INPUT_EVENT_ID_TOUCH_SCREEN:
    {
      ...
      {
        case msg_reg_win_02:
          exitFrame( NetApp::RegulationSelect::SELECT_LOAD_RESULT_SUCCESS_TO_MAIN );
        break;
      }
    }
    break;
...
//-----------------------------------------------------------------------------
void RegulationSelectLoadFrame::onLoadRegulationDataSuccess()
{
  exitFrame( NetApp::RegulationSelect::SELECT_LOAD_RESULT_SUCCESS_TO_MAIN );
}


void RegulationSelectLoadFrame::onLoadRegulationDataError()
{
...
void RegulationSelectLoadFrame::onLoadRegulationDataFatalError()
{
