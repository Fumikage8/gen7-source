//======================================================================
/**
 * @file BattleVideoRecordingUppRootView.h
  ...
  bool UppRootView::InitFunc()
  {
    if( m_initSeq == 0 )
    {
      ...
      //  BGのループアニメ
      {
        ...
        pG2DUtil->StartAnime( LYT_WORK_NORMAL, LA_BATTLEVIDEORECORDINGLYTDATA_BVR_MIN_UPP_000__BG_WAVE_BLUE_UPP_01_BG_LOOP_00 );
      }
  ...
  */
  ...
  void UppRootView::_Initialize2D( void* pAppLytBuff, gfl2::str::MsgData* pAppMsgData, print::WordSet* pWordSet )
  {
    ...
    const ::app::util::G2DUtil::LytwkData aSetupData[ LYT_WORK_MAX ] =
    {
      {
        0,
        LYTRES_BATTLEVIDEORECORDINGLYTDATA_BVR_MIN_UPP_000_BFLYT,
        LA_BATTLEVIDEORECORDINGLYTDATA_BVR_MIN_UPP_000___NUM,
        pAppLytBuff,
        true,
