...
#if !defined  
#define __BATTLE_VIDEO_RECORDING_LOW_ROOT_VIEW_H_INCLUDED__
#pragma once
...
GFL_NAMESPACE_BEGIN(BattleVideoRecording)
  ...
  public:
    ...
    /**
      ...
      */
    //------------------------------------------------------------------
    virtual void OnVideoRecordingLowRootViewKeyAction( gfl2::ui::Button* pButton, gfl2::ui::VectorDevice* pKey, gfl2::ui::VectorDevice* pStick ) = 0;
  };
  ...
  public:
    ...
    */
    ...
    /**
      ...
      */
    //------------------------------------------------------------------
    void ShowMessageDialog( gfl2::str::StrBuf* pStrBuf, const bool bUseInput, const bool bShowTimerIcon );
...
#endif // __BATTLE_VIDEO_RECORDING_LOW_ROOT_VIEW_H_INCLUDED__