#if !defined(EGGHATCHINGRESOURCE_H_INCLUDED)
#define EGGHATCHINGRESOURCE_H_INCLUDED
#pragma once
//==============================================================================
/**
 * @file   EggHatchingResource.h
 * @date   2015/11/24 Tue. 15:36:21
 * @author muto_yu
 * @brief  
 * @par Copyright
...
#include  <niji_conv_header/message/msg_tamago_demo.h>
/*  commonWindow  */
...
static const gfl2::fs::ArcFile::ARCDATID  EGGHATCHING_MESSAGE_GRAC_ID  = GARC_message_tamago_demo_DAT;

/*  demo  */
static const u32  DEMO_PARENT_HEAP_ID    = HEAPID_APP_DEVICE;
static const gfl2::fs::ArcFile::ARCDATID  EGGHATCHING_DEMO_GRAC_ID_Hatching       = GARC_demo_seq_script_sd9100_egg_BSEQ;
static const gfl2::fs::ArcFile::ARCDATID  EGGHATCHING_DEMO_GRAC_ID_Hatching_Alola = GARC_demo_seq_script_sd9100_egg_alola_BSEQ;


} /*  namespace EggHatching */
} /*  namespace NetApp      */
#endif  /*  #if !defined(EGGHATCHINGRESOURCE_H_INCLUDED)  */
