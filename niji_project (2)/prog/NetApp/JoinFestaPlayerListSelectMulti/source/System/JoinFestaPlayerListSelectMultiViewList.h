// ============================================================================
/*
 * @file JoinFestaPlayerListSelectMultiViewList.h
 * @brief プレイヤー複数選択アプリのViewリストです。
 * @date 2015.10.20
 * @author endo_akira
 */
// ============================================================================
#if !defined( JOINFESTAPLAYERLISTSELECTMULTI_VIEWLIST_H_INCLUDE )
#define JOINFESTAPLAYERLISTSELECTMULTI_VIEWLIST_H_INCLUDE
#pragma once
...
{
  GFL_FORBID_COPY_AND_ASSIGN( JoinFestaPlayerListSelectMultiViewList );

public:

  JoinFestaPlayerListSelectMultiViewList( app::util::Heap* pAppHeap );
  virtual~JoinFestaPlayerListSelectMultiViewList();
...
#endif // JOINFESTAPLAYERLISTSELECTMULTI_VIEWLIST_H_INCLUDE
