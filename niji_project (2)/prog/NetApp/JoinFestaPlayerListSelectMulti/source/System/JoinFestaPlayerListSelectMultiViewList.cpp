// ============================================================================
/*
 * @file JoinFestaPlayerListSelectMultiViewList.cpp
...
JoinFestaPlayerListSelectMultiViewList::JoinFestaPlayerListSelectMultiViewList( app::util::Heap* pAppHeap ) :
...
JoinFestaPlayerListSelectMultiViewList::~JoinFestaPlayerListSelectMultiViewList()
{
...
void JoinFestaPlayerListSelectMultiViewList::Update()
{
...
void JoinFestaPlayerListSelectMultiViewList::Draw( gfl2::gfx::CtrDisplayNo displayNo )
{
...
void JoinFestaPlayerListSelectMultiViewList::AddUpperView( NetAppLib::System::NetApplicationViewBase* pView )
{
...
void JoinFestaPlayerListSelectMultiViewList::AddLowerView( NetAppLib::System::NetApplicationViewBase* pView )
{
...
void JoinFestaPlayerListSelectMultiViewList::AddUpperViewInputEnable( NetAppLib::System::NetApplicationViewBase* pView )
{
  m_pActiveUpperView->AddSubView( pView );
  m_pActiveUpperView = pView;
...
void JoinFestaPlayerListSelectMultiViewList::AddLowerViewInputEnable( NetAppLib::System::NetApplicationViewBase* pView )
{
  m_pActiveLowerView->AddSubView( pView );
  m_pActiveLowerView = pView;
  pView->SetInputEnabled( true );
...
void JoinFestaPlayerListSelectMultiViewList::AddUpperViewInputDisable( NetAppLib::System::NetApplicationViewBase* pView )
{
  m_pActiveUpperView->AddSubView( pView );
  m_pActiveUpperView = pView;
...
void JoinFestaPlayerListSelectMultiViewList::AddLowerViewInputDisable( NetAppLib::System::NetApplicationViewBase* pView )
{
  m_pActiveLowerView->AddSubView( pView );
  m_pActiveLowerView = pView;
  pView->SetInputEnabled( false );
...
void JoinFestaPlayerListSelectMultiViewList::RemoveUpperView()
{
...
void JoinFestaPlayerListSelectMultiViewList::RemoveLowerView()
{
...
void JoinFestaPlayerListSelectMultiViewList::RemoveAllView()
{
