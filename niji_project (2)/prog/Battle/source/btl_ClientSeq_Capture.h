 ...
 */
//=============================================================================
#if !defined BTL_CLIENTSEQ_CAPTURE_H_INCLUDED
#define BTL_CLIENTSEQ_CAPTURE_H_INCLUDED
#pragma once
...
GFL_NAMESPACE_BEGIN( btl )
  ...
  class ClientSeq_Capture
  {
    GFL_FORBID_COPY_AND_ASSIGN( ClientSeq_Capture );
...
#endif // BTL_CLIENTSEQ_CAPTURE_H_INCLUDED