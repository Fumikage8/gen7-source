...
// 
//===================================================================================================================================================
class CtrGfbvshDummy : public gfl2::gfx::GLMemory
{
public:
//-----------------------------------------------
// コンストラクタ
	CtrGfbvshDummy():gfl2::gfx::GLMemory()
  {
    m_CtrGfbvsh = NULL;
    m_CtrGfbvshSize = 0;
  }
...
// 
//===================================================================================================================================================
class CtrGfbfshDummy : public gfl2::gfx::GLMemory
{
public:
//-----------------------------------------------
// コンストラクタ
	CtrGfbfshDummy() : gfl2::gfx::GLMemory()
  {
    m_CtrGfbfsh = NULL;
    m_CtrGfbfshSize = 0;
  }
