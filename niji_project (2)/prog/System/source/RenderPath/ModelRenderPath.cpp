...
void ModelRenderPath::AddSheneCamera(gfl2::renderingengine::renderer::RenderingPipeLine::SceneRenderPath::Camera* pCamera)
{
  mpCamera = pCamera;
}

void ModelRenderPath::RemoveSheneCamera(void)
{
  mpCamera = NULL;
}
