//======================================================================
/**
 * @file ObstacleStorage.h
 * @date 2016/10/26 18:48:34
 * @author arai_takashi
 * @brief 簡単な説明
 * @par Copyright
...
#if !defined __LUNA_SOL_DIVE__GIMMICK__OBSTACLE_STORAGE_H_INCLUDED__
#define __LUNA_SOL_DIVE__GIMMICK__OBSTACLE_STORAGE_H_INCLUDED__
#pragma once
...
class ObstacleStorage: public ObjectStorage
{
  GFL_FORBID_COPY_AND_ASSIGN(ObstacleStorage);
public:
  // constructor
  ObstacleStorage();
  // Initialize
  ...
  void SetVanishingMotion(
              poke_3d::model::BaseModel* pModel);
  // Distance at the obstacle activation (override)
...
#endif // __LUNA_SOL_DIVE__GIMMICK__OBSTACLE_STORAGE_H_INCLUDED__
