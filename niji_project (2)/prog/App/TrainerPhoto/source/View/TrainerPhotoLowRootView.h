...
#if !defined  
#define __TRAINER_PHOTO_LOW_ROOT_VIEW_H_INCLUDED__
#pragma once
...
GFL_NAMESPACE_BEGIN(photo)
  ...
  class TrainerPhotoLowRootViewInputDelegate
  {
  public:
    //------------------------------------------------------------------
    /**
  ...
  /**
   * @class TrainerPhotoLowRootView
   * @brief 証明写真アプリの下画面インフォView
   */
  class TrainerPhotoLowRootView : 
  ...
  {
      GFL_FORBID_COPY_AND_ASSIGN(TrainerPhotoLowRootView);
  ...
  public:
    ...
    /**
      ...
      */
    //------------------------------------------------------------------
    TrainerPhotoLowRootView( INIT_PARAM& rInitParam );

    virtual ~TrainerPhotoLowRootView();
    ...
    */
    ...
    /**
      ...
      */
    //------------------------------------------------------------------
    bool IsInput() const { return ( m_state == STATE_INPUT_STOP ); }
    ...
    /**
      ...
      */
    //------------------------------------------------------------------
    void SetInputDelegate( TrainerPhotoLowRootViewInputDelegate* pDelegate )
    {
    ...
    /**
      ...
      */
    //------------------------------------------------------------------
    void SetEnterButtonText( gfl2::str::StrBuf* pStrBuf );
    ...
    /**
      ...
      */
    //------------------------------------------------------------------
    void ShowMessageWindow( gfl2::str::StrBuf* pStrBuf );
    ...
    /**
      ...
      */
    //------------------------------------------------------------------
    void ShowMessageDialog( gfl2::str::StrBuf* pStrBuf, const u32 showTime );
  ...
  private:
    ...
    void _Clear()
    {
      ...
      m_pCommonMessageDialog    = NULL;
      m_pMessageDialogPartPane  = NULL;
    ...
    gfl2::lyt::LytParts*            m_pMessageDialogPartPane;
    gfl2::lyt::LytTextBox*          m_pEnterButtonTextPane;
    gfl2::lyt::LytTextBox*          m_pMessageWindowTextPane;

    //  汎用ウィンドウダイアログ
    App::Tool::CommonMessageWindowManipulator*  m_pCommonMessageDialog;

    TrainerPhotoLowRootViewInputDelegate* m_pInputDelegate;
  };

GFL_NAMESPACE_END(photo)
GFL_NAMESPACE_END(app)

#endif // __TRAINER_PHOTO_LOW_ROOT_VIEW_H_INCLUDED__