#ifndef NIJI_PROJECT_APP_POKELIST_UPPER_DRAW_H_INCLUDED
#define NIJI_PROJECT_APP_POKELIST_UPPER_DRAW_H_INCLUDED
#pragma once
//======================================================================
/**
 * @file    PokeListUpperDraw.h
 * @date    2015/08/28 16:58:14
...
{
  GFL_FORBID_COPY_AND_ASSIGN( PokeListUpperDraw );
...
public:
   ...
   */
  //------------------------------------------------------------------
  PokeListUpperDraw( app::util::Heap * heap, app::util::AppRenderingManager* pAppRanderingManager );
   ...
   */
  //------------------------------------------------------------------
  virtual ~PokeListUpperDraw( void ) { ; }
...
#endif // NIJI_PROJECT_APP_POKELIST_UPPER_DRAW_H_INCLUDED