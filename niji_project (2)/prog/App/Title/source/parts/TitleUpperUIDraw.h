 ...
 */
//=============================================================================
#if !defined( NIJI_PROJECT_TITLE_UPPER_UI_DRAW_H_INCLUDED )
#define NIJI_PROJECT_TITLE_UPPER_UI_DRAW_H_INCLUDED
#pragma once
...
GFL_NAMESPACE_BEGIN( title )
  ...
  /** タイトル上UI画面 */
  class TitleUpperUIDraw : public ::app::ui::UIView
  {
    GFL_FORBID_COPY_AND_ASSIGN( TitleUpperUIDraw );  // コピーを禁止
    ...
    public:
      ...
      * @brief コンストラクタ
      */
      TitleUpperUIDraw( const INIT_PARAM& param );

      /**
      * @brief デストラクタ
      */
      virtual ~TitleUpperUIDraw();
...
#endif // NIJI_PROJECT_TITLE_UPPER_UI_DRAW_H_INCLUDED 
