...
GFL_NAMESPACE_BEGIN( title )
  ...
  /**
    ...
    */
  //-------------------------------------------------------------------------
  TitleLowerUIDraw::TitleLowerUIDraw( const INIT_PARAM& param ) :
  ...
  /**
    ...
    */
  //-------------------------------------------------------------------------
  TitleLowerUIDraw::~TitleLowerUIDraw()
  {
  ...
  /**
    ...
    */
  //------------------------------------------------------------------
  void TitleLowerUIDraw::Initialize()
  {
  ...
  /**
    ...
    */
  //------------------------------------------------------------------
  void TitleLowerUIDraw::Terminate()
  {
  }
  ...
  /**
    ...
    */
  //-------------------------------------------------------------------------
  void TitleLowerUIDraw::Draw(  gfl2::gfx::CtrDisplayNo displayNo )
  {
  ...
  /**
    * @brief レイアウトワークを生成する
    */
  void TitleLowerUIDraw::_Initialize2D( void* pAppLytBuff )
  {
    //  2D画面作成
    {
      // アーカイブIDテーブル
  ...
  /**
    ...
    */
  //------------------------------------------------------------------
  void TitleLowerUIDraw::_UpdateState()
  {
    ::app::util::G2DUtil* pG2DUtil  = UIView::GetG2DUtil();
  ...
  /**
    ...
    */
  //------------------------------------------------------------------
  void TitleLowerUIDraw::_SetState( const StateType newStateType )
  {
