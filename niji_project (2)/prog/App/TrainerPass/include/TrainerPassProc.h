//=============================================================================
/**
 * @file    TrainerPassProc.h
 * @brief   トレーナーパス画面Proc処理
 * @author  Hiroyuki Nakamura
 * @date    2015.11.06
 */
//=============================================================================
#if !defined( TRAINER_PASS_PROC_H_INCLUDED )
#define TRAINER_PASS_PROC_H_INCLUDED
...
//=============================================================================
/**
 * @class TrainerPassProc
 * @brief トレーナーパス画面Procクラス
 * @date  2015.11.06
 */
//=============================================================================
class TrainerPassProc
...
{
  GFL_FORBID_COPY_AND_ASSIGN(TrainerPassProc);  // コピーコンストラクタ＋代入禁止
...
#endif  // TRAINER_PASS_PROC_H_INCLUDED
