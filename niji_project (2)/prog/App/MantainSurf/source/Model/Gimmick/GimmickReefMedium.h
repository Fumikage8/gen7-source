...
#if !defined __GIMMICK_REEF_MEDIUM_H_INCLUDED__
#define __GIMMICK_REEF_MEDIUM_H_INCLUDED__
#pragma once
...
class GimmickReefMedium : public GimmickBaseStatic
{
  GFL_FORBID_COPY_AND_ASSIGN(GimmickReefMedium);
...
#endif // __GIMMICK_REEF_MEDIUM_H_INCLUDED__
