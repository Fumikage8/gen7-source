//======================================================================
/**
 * @file LangSelectProc.cpp
 * @date 2015/07/23 15:08:59
...
void Proc::EndFuncFinish( applib::frame::CellSuper* pEndCell )
{
  ...
  if( m_pLangSelectFrame == pEndCell )
  {
    m_pLangSelectFrame = NULL;
  }
}
...
//------------------------------------------------------------------------------
/**
 * @brief   LangSelectFrameの生成
 */
//------------------------------------------------------------------------------
void Proc::CreateLangSelectFrame( void )
{
  m_pLangSelectFrame = MENU_FRAME_CALL_MODAL<applib::frame::Manager, LangSelectFrame>( this->GetFrameManager() );
  m_pLangSelectFrame->Setup( m_pAppParam, m_pAppHeap, m_pAppRenderingManager );
}
