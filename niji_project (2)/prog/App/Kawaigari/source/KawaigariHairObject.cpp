//======================================================================
/**
 * @file	KawaigariHairObject.C++
 * @brief	Kawaigari Hair Object Code
 * @author	PETE
 * @data	2015.1.21
 */
//======================================================================
...
KawaigariHairObject::KawaigariHairObject(void)
...
void KawaigariHairObject::State_Idle(void)
{
  ...
  if(coreSys->GetPokemonAI()->GetCareToolType()!=CARETOOL_HAIR) return;

  // Shake the effect when scrubbing:
  if(mScrub)
  {
    mShake = true;
  }
...
void KawaigariHairObject::State_Main(void)
{
  
}

void KawaigariHairObject::State_End(void)
{
  mShake = false;
  mScrub = false;
}
...
void KawaigariHairObject::State_Cleanup(void)
{

}

void KawaigariHairObject::State_Finish(void)
{
