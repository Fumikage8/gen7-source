//=============================================================================
/**
 * @file    ParurePokeListProc.h
 * @brief   ポケパルレポケモン選択画面Proc処理
 * @author  Hiroyuki Nakamura
 * @date    2015.11.12
 */
//=============================================================================
#if !defined( PARURE_POKELIST_PROC_H_INCLUDED )
#define PARURE_POKELIST_PROC_H_INCLUDED
...
//=============================================================================
/**
 * @class ParurePokeListProc
 * @brief ポケパルレポケモン選択画面Procクラス
 * @date  2015.11.12
 */
//=============================================================================
class ParurePokeListProc
...
{
  GFL_FORBID_COPY_AND_ASSIGN(ParurePokeListProc);  // コピーコンストラクタ＋代入禁止
...
private:
  ...
  ParurePokeListFrame * m_pFrame;   //!< パルレリストのフレーム
};
...
#endif  // PARURE_POKELIST_PROC_H_INCLUDED
