#if !defined( __APP_STATUS_DRAWER_BASE_H_INCLUDED__ )
#define __APP_STATUS_DRAWER_BASE_H_INCLUDED__
#pragma once
//======================================================================
/**
 * @file    StatusDrawerBase.h
 * @date    2015/11/27 17:24:53
...
public:
   ...
   */
  //------------------------------------------------------------------
  DrawerBase( app::ui::UIView* pUIView, app::util::Heap* pHeap, u32 layout_id, gfl2::str::MsgData* pMsgData, print::WordSet* pWordSet );
...
public: //!< ペイン関連
   ...
   */
  //------------------------------------------------------------------
  gfl2::math::VEC3 GetPanePos( gfl2::lyt::LytPane* pPane );
   ...
   */
  //------------------------------------------------------------------
  void AppendChildPane( u8 plateIndex, u8 appendType );
...
public: //!< 取得関連
   ...
   */
  //------------------------------------------------------------------
  gfl2::lyt::LytMultiResID& GetLytMultiResID( void );
...
public:
   ...
   */
  //------------------------------------------------------------------
  void SetNullCursor( gfl2::lyt::LytPane* paneTbl[] );
...
#endif // __APP_STATUS_DRAWER_BASE_H_INCLUDED__
