//======================================================================
/**
 * @file    TitleMenuProc.cpp
 * @date    2015/07/21 13:34:17
...
static const u32 SIZE_MY_APPDEV     = 12 * 1024 * 1024;     //!< 12Mバイト
...
//------------------------------------------------------------------------------
/**
 * @brief   TitleMenuFrameの生成
 */
//------------------------------------------------------------------------------
void Proc::CreateTitleMenuFrame( void )
{
  m_pTitleMenuFrame = MENU_FRAME_CALL_MODAL<applib::frame::Manager, TitleMenuFrame>( this->GetFrameManager() );
  m_pTitleMenuFrame->Setup( m_pAppParam, m_pAppHeap, m_pAppRenderingManager );
}
