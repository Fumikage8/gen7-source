#if !defined( __FINDER_MENU_DRAWER_BASE_H__ )
#define __FINDER_MENU_DRAWER_BASE_H__
#pragma once
//======================================================================
/**
 * @file    FinderMenuDrawerBase.h
 * @date    2015/11/02 19:08:45
...
public: //!< ペイン関連
   ...
   */
  //------------------------------------------------------------------
  u8 GetAlpha( gfl2::lyt::LytPane* pPane );
...
#endif // __FINDER_MENU_DRAWER_BASE_H__