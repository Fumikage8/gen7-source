//======================================================================
/**
 * @file    FinderMenuProc.cpp
 * @date    2015/11/02 12:57:21
 * @author  fukushima_yuya
 * @brief   ファインダーメニューProc
 * @par Copyright
...
static const u32 SIZE_MY_APP       = 1 * 1024 * 1024;     //!< 1バイト
static const u32 SIZE_MY_APPDEV    = 8 * 1024 * 1024;     //!< 8Mバイト
...
{
  m_pFrame = MENU_FRAME_CALL_MODAL<applib::frame::Manager, FinderMenuFrame>( this->GetFrameManager() );
  m_pFrame->Setup( m_pAppParam, m_pAppHeap, m_pAppRenderingManager );
}
