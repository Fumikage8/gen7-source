//======================================================================
/**
 * @file FinderDrawerBase.cpp
 * @date 2015/10/22 12:38:43
...
//------------------------------------------------------------------------------
   ...
   */
  //----------------------------------------------------------------------------
  f32 DrawerBase::GetAnimFrame( u32 anmID )
  {
   ...
   */
  //----------------------------------------------------------------------------
  f32 DrawerBase::GetAnimMaxFrame( u32 anmID )
  {
    return GetG2D()->GetAnimeMaxFrame( m_LayoutID, anmID );
  }
