...
static const u32 LOCAL_HEAP_SIZE        = 0x00B000;   //!< ローカルヒープサイズ
static const u32 LOCAL_DEVICE_HEAP_SIZE = 0x184000;   //!< ローカルデバイスヒープサイズ
 ...
 */
//-----------------------------------------------------------------------------
void ShopProc::Setup( APP_PARAM * param, gfl2::heap::HeapBase * heap )
{
  m_param = param;
  m_parentHeap = heap;
}
 ...
 */
//-----------------------------------------------------------------------------
gfl2::proc::Result ShopProc::InitFunc( gfl2::proc::Manager * pManager )
{
  switch( GetSubSeq() )
  {
  case 0:
 ...
 */
//-----------------------------------------------------------------------------
gfl2::proc::Result ShopProc::EndFunc( gfl2::proc::Manager * pManager )
{
  switch( GetSubSeq() )
  {
  case 0:
 ...
 */
//-----------------------------------------------------------------------------
gfl2::proc::Result ShopProc::UpdateFunc( gfl2::proc::Manager * pManager )
{
 ...
 */
//-----------------------------------------------------------------------------
void ShopProc::PreDrawFunc( gfl2::proc::Manager * pManager )
{
 ...
 */
//-----------------------------------------------------------------------------
void ShopProc::DrawFunc( gfl2::proc::Manager * pManager, gfl2::gfx::CtrDisplayNo displayNo )
{
 ...
 */
//-----------------------------------------------------------------------------
void ShopProc::CreateRenderManager(void)
{
 ...
 */
//-----------------------------------------------------------------------------
bool ShopProc::DeleteRenderManager(void)
{
 ...
 */
//-----------------------------------------------------------------------------
void ShopProc::CreateFrame(void)
{
  m_pFrameManager = GFL_NEW(m_pManagerHeap) applib::frame::Manager( m_pManagerHeap );
  m_pFrame = MENU_FRAME_CALL_MODAL< applib::frame::Manager, ShopFrame >( m_pFrameManager );
 ...
 */
//-----------------------------------------------------------------------------
bool ShopProc::DeleteFrame(void)
{
