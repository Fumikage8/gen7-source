// ============================================================================
/*
 * @file StaffrollViewList.h
 * @brief スタッフロールアプリのViewリストです。
 * @date 2016.01.06
 * @author uchida_yuto
 */
// ============================================================================
#if !defined( STAFFROLL_VIEW_LIST_H_INCLUDE )
#define STAFFROLL_VIEW_LIST_H_INCLUDE
#pragma once
...
GFL_NAMESPACE_BEGIN(System)
  ...
  {
    GFL_FORBID_COPY_AND_ASSIGN( StaffrollViewList );

  public:

    StaffrollViewList( app::util::Heap* pAppHeap );
    virtual~StaffrollViewList();
...
#endif // STAFFROLL_VIEW_LIST_H_INCLUDE
