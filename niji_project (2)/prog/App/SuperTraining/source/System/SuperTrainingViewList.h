// ============================================================================
/*
 * @file SuperTrainingViewList.h
 * @brief すごい特訓アプリのViewリストです。
 * @date 2015.12.07
 * @author uchida_yuto
 */
// ============================================================================
#if !defined( SUPER_TRAINING_VIEWLIST_H_INCLUDE )
#define SUPER_TRAINING_VIEWLIST_H_INCLUDE
#pragma once
...
#endif // SUPER_TRAINING_VIEWLIST_H_INCLUDE
