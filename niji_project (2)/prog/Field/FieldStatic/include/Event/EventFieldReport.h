...
//=================================================================================================
#pragma once
#ifndef __EVENT_FIELD_REPORT_H__
#define __EVENT_FIELD_REPORT_H__
...
class EventFieldReport : public GameSys::GameEvent
{
  GFL_FORBID_COPY_AND_ASSIGN( EventFieldReport ); // コピーを禁止
...
public:
   ...
   */
  //--------------------------------------------------------------
  EventFieldReport( gfl2::heap::HeapBase* heap );
  virtual ~EventFieldReport();
...
#endif // __EVENT_FIELD_REPORT_H__
