...
#if !defined( EVENT_RIDE_DEBUG_H_INCLUDE )
#define EVENT_RIDE_DEBUG_H_INCLUDE
...
class EventDebugRidePokemon : public GameSys::GameEvent
{
  GFL_FORBID_COPY_AND_ASSIGN( EventDebugRidePokemon );

public:

  static void StartEvent( GameSys::GameManager* pGameManager,u32 continueCnt );

  EventDebugRidePokemon();
  EventDebugRidePokemon( gfl2::heap::HeapBase* pHeap );
  virtual~EventDebugRidePokemon();
