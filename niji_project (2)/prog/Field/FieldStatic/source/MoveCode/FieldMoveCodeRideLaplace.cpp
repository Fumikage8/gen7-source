...
*/
//-----------------------------------------------------------------------------
FieldMoveCodeRideLaplace::FieldMoveCodeRideLaplace(void)
: m_slipRateDash(0.4f)
, m_slipRateWalk(0.2f)
{
  // 待機
  {
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_WAIT            ].motionId     = P2_BASE_RI100_WAIT01;
  ...
  }
  {
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_WAIT_TOKUSHU    ].motionId     = P2_BASE_RI107_SPEEDUPWAIT01;
  ...
  // 歩き
  {
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_WALK_START      ].motionId     =  P2_BASE_RI105_RUNSTART01;
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_WALK_LOOP       ].motionId     =  P2_BASE_RI104_RUN01;
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_WALK_END        ].motionId     =  P2_BASE_RI106_RUNSTOP01;
  ...
  // 走り
  {
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_RUN_START       ].motionId     = P2_BASE_RI109_SPEEDUPSTART01;
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_RUN_LOOP        ].motionId     = P2_BASE_RI108_SPEEDUP01;
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_RUN_END         ].motionId     = P2_BASE_RI110_SPEEDUPSTOP01;
...
*/
//-----------------------------------------------------------------------------
FieldMoveCodeRideLaplace::~FieldMoveCodeRideLaplace()
{
}
...
*/
//-----------------------------------------------------------------------------
void FieldMoveCodeRideLaplace::InitProcess(FieldMoveCodeWork* pMoveCodeWork) const
{
  ...
  //動作コードIDを上書き
  pMoveCodeWork->moveCodeId = FIELD_MOVE_CODE_RIDE_LAPLACE;
}
...
*/
//-----------------------------------------------------------------------------
void FieldMoveCodeRideLaplace::RegistRtti(void) const
{
#if USE_RTTI_DEBUG
  // この記述がなければ親のメンバ変数はエディタに登録されません
  RTTI_BASE_PARENT(FieldMoveCodeRideLaplace,FieldMoveCodePlayer);

  RTTI_START_REGIST( 256 );
    RTTI_PARAM_REGIST_ATTR( FieldMoveCodeRideLaplace , m_slipRateDash , L"ジェット：カーブ時の膨らみやすさ" , gfl2::rttidebug::RttiParamManager::ATTR_ADD_SMALL );
    RTTI_PARAM_REGIST_ATTR( FieldMoveCodeRideLaplace , m_slipRateWalk , L"歩き　　：カーブ時の膨らみやすさ" , gfl2::rttidebug::RttiParamManager::ATTR_ADD_SMALL );
  RTTI_END_REGIST( FieldMoveCodeRideLaplace );
