...
*/
//-----------------------------------------------------------------------------
FieldMoveCodeRideSamehader::FieldMoveCodeRideSamehader(void)
: m_slipRateDash(1.4f)
, m_slipRateWalk(0.0f)
{
  // 待機
  {
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_WAIT            ].motionId     = P2_BASE_RI020_WAIT01;
  ...
  }
  {
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_WAIT_TOKUSHU    ].motionId     = P2_BASE_RI027_JETWAIT01;
  ...
  // 歩き
  {
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_WALK_START      ].motionId     =  P2_BASE_RI025_RUNSTART01;
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_WALK_LOOP       ].motionId     =  P2_BASE_RI024_RUN01;
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_WALK_END        ].motionId     =  P2_BASE_RI026_RUNSTOP01;
  ...
  // 走り
  {
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_RUN_START       ].motionId     = P2_BASE_RI029_JETSTART01;
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_RUN_LOOP        ].motionId     = P2_BASE_RI028_JET01;
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_RUN_END         ].motionId     = P2_BASE_RI030_JETSTOP01;
...
*/
//-----------------------------------------------------------------------------
FieldMoveCodeRideSamehader::~FieldMoveCodeRideSamehader()
{
}
...
*/
//-----------------------------------------------------------------------------
void FieldMoveCodeRideSamehader::InitProcess(FieldMoveCodeWork* pMoveCodeWork) const
{
  ...
  //動作コードIDを上書き
  pMoveCodeWork->moveCodeId = FIELD_MOVE_CODE_RIDE_SAMEHADER;
}
...
*/
//-----------------------------------------------------------------------------
void FieldMoveCodeRideSamehader::RegistRtti(void) const
{
#if USE_RTTI_DEBUG
  // この記述がなければ親のメンバ変数はエディタに登録されません
  RTTI_BASE_PARENT(FieldMoveCodeRideSamehader,FieldMoveCodePlayer);

  RTTI_START_REGIST( 256 );
    RTTI_PARAM_REGIST_ATTR( FieldMoveCodeRideSamehader , m_slipRateDash , L"ジェット：カーブ時の膨らみやすさ" , gfl2::rttidebug::RttiParamManager::ATTR_ADD_SMALL );
    RTTI_PARAM_REGIST_ATTR( FieldMoveCodeRideSamehader , m_slipRateWalk , L"歩き　　：カーブ時の膨らみやすさ" , gfl2::rttidebug::RttiParamManager::ATTR_ADD_SMALL );
  RTTI_END_REGIST( FieldMoveCodeRideSamehader );
