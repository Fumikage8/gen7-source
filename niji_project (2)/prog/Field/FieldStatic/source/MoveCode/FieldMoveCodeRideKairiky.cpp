...
*/
//-----------------------------------------------------------------------------
FieldMoveCodeRideKairiky::FieldMoveCodeRideKairiky(void)
: m_isAcceptJump(true)
{
  // 待機
  {
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_WAIT            ].motionId     = P2_BASE_RI080_WAIT01;
  ...
  }
  {
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_WAIT_TOKUSHU    ].motionId     = P2_BASE_RI087_STRENGTHWAIT01;
  ...
  // 歩き
  {
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_WALK_START      ].motionId     =  P2_BASE_RI083_RUNSTART01;
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_WALK_LOOP       ].motionId     =  P2_BASE_RI082_RUN01;
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_WALK_END        ].motionId     =  P2_BASE_RI084_RUNSTOP01;
  ...
  // 走り
  {
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_RUN_START       ].motionId     = P2_BASE_RI088_STRENGTHRUNSTART01;
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_RUN_LOOP        ].motionId     = P2_BASE_RI089_STRENGTHRUN01;
    ...
    m_PlayerMoveSettingTable[ PLAYER_MOVE_RUN_END         ].motionId     = P2_BASE_RI090_STRENGTHRUNSTOP01;
...
*/
//-----------------------------------------------------------------------------
FieldMoveCodeRideKairiky::~FieldMoveCodeRideKairiky()
{
}
...
*/
//-----------------------------------------------------------------------------
void FieldMoveCodeRideKairiky::InitProcess(FieldMoveCodeWork* pMoveCodeWork) const
{
  FieldMoveCodePlayer::InitProcess( pMoveCodeWork );

  //動作コードIDを上書き
  pMoveCodeWork->moveCodeId = FIELD_MOVE_CODE_RIDE_KAIRIKY;
}
...
*/
//-----------------------------------------------------------------------------
void FieldMoveCodeRideKairiky::RegistRtti(void) const
{
#if USE_RTTI_DEBUG

  // この記述がなければ親のメンバ変数はエディタに登録されません
  RTTI_BASE_PARENT(FieldMoveCodeRideKairiky,FieldMoveCodePlayer);

  RTTI_START_REGIST( 256 );
    RTTI_PARAM_REGIST     ( FieldMoveCodeRideKairiky , m_isAcceptJump        , L"段差ジャンプができる"     );
  RTTI_END_REGIST( FieldMoveCodeRideKairiky );
