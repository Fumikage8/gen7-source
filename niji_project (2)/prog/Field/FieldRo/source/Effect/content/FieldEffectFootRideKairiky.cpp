//======================================================================
/**
 * @file FieldEffectFootRideKairiky.cpp
 * @date 2015/11/13 14:51:07
 ...
 *  @brief  コンストラクタ
 */
EffectFootRideKairiky::EffectFootRideKairiky( void )
  :IEffectBase()
  ,m_pModel( NULL )
  ,m_pAllocator( NULL )
 ...
 *  @brief  初期化
 */
void EffectFootRideKairiky::Initialize( SetupData &setupData )
{
 ...
 *  @brief  破棄
 */
bool EffectFootRideKairiky::Terminate( void )
{
 ...
 *  @brief  更新
 */
void EffectFootRideKairiky::updateNormal( void )
{
 ...
 */
void EffectFootRideKairiky::Delete( void )
{
 ...
 *  @brief  モデルの作成
 */
void EffectFootRideKairiky::createModel( void *pModelBinary )
{
  // モデルリソース作成
 ...
 *  @brief  モーションの作成
 */
void EffectFootRideKairiky::createMotion( void *pMotionBinary )
{
 ...
 *  @brief  オフセットを設定
 */
void EffectFootRideKairiky::SetOffset( b32 isReverse , gfl2::math::Vector3 offset )
{
