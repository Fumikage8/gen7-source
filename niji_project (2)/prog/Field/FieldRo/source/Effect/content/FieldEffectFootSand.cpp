//======================================================================
/**
 * @file FieldEffectFootSand.cpp
 * @date 2015/11/13 12:55:31
 ...
 *  @brief  コンストラクタ
 */
EffectFootSand::EffectFootSand( void )
: IEffectBase()
, m_pEffectHeap( NULL )
 ...
 *  @brief  初期化
 */
void EffectFootSand::Initialize( SetupData &setupData )
{
  ...
  m_pEffectSystem->CreateEmitterSetID( m_pEffectHandle, setupData.vPos, 0, EFFECT_RESOURCE_FOOT_SAND );
}

/**
 *  @brief  破棄
 */
bool EffectFootSand::Terminate( void )
{
 ...
 *  @brief  オフセットを設定
 */
void EffectFootSand::SetOffset( gfl2::math::Vector3 offset,gfl2::math::Vector3 offsetQua )
{
  // エミッター
 ...
 *  @brief  更新処理
 */
void EffectFootSand::updateNormal( void )
{
  if( !m_pEffectHandle->GetEmitterSet() )
  {
    RequestDelete();
