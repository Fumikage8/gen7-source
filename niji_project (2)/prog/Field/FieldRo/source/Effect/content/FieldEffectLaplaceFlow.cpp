//======================================================================
/**
 * @file FieldEffectLaplaceFlow.cpp
 ...
 *  @brief  コンストラクタ
 */
EffectLaplaceFlow::EffectLaplaceFlow( void )
: IEffectBase()
, m_pEffectHeap( NULL )
 ...
 *  @brief  初期化
 */
void EffectLaplaceFlow::Initialize( SetupData &setupData )
{
 ...
 *  @brief  破棄
 */
bool EffectLaplaceFlow::Terminate( void )
{
  // 再生停止
 ...
 */
void EffectLaplaceFlow::Delete( void )
{
}
 ...
 *  @brief  エミッター作成
 */
void EffectLaplaceFlow::CreateEmitter( void )
{
  // 再生終了しているなら削除
  if( m_pEffectHandle->GetEmitterSet()
  ...
  if( !isAlive )
  {
    ...
    m_pEffectSystem->CreateEmitterSetID( m_pEffectHandle, pos, 0, EFFECT_RESOURCE_LAPLACE_FLOW );
    updatePosition();
  }
}
 ...
 *  @brief  エミッター削除
 */
void EffectLaplaceFlow::DeleteEmitter( void )
{
  // 再生終了しているなら削除
 ...
 *  @brief  更新処理
 */
void EffectLaplaceFlow::updateNormal( void )
{
  // 座標更新
  updatePosition();
}
 ...
 *  @brief  座標更新
 */
void EffectLaplaceFlow::updatePosition( void )
{
 ...
 *  @brief  座標オフセットの設定
 */
void EffectLaplaceFlow::setOffsetPosition( gfl2::math::Vector3 offsetPos )
{
