//======================================================================
/**
 * @file FieldEffectRoba2WalkSmoke.cpp
 ...
 *  @brief  コンストラクタ
 */
EffectRoba2WalkSmoke::EffectRoba2WalkSmoke( void )
: IEffectBase()
, m_pEffectHeap( NULL )
 ...
 *  @brief  初期化
 */
void EffectRoba2WalkSmoke::Initialize( SetupData &setupData )
{
  ...
  m_pEffectSystem->CreateEmitterSetID( m_pEffectHandle, setupData.vPos, 0, EFFECT_RESOURCE_ROBA2_WALK_SMOKE );
}

/**
 *  @brief  破棄
 */
bool EffectRoba2WalkSmoke::Terminate( void )
{
 ...
 *  @brief  オフセットを設定
 */
void EffectRoba2WalkSmoke::SetOffset( gfl2::math::Vector3 offset,gfl2::math::Vector3 offsetQua )
{
  // エミッター
 ...
 *  @brief  更新処理
 */
void EffectRoba2WalkSmoke::updateNormal( void )
{
  if( !m_pEffectHandle->GetEmitterSet() )
  {
    RequestDelete();
