//======================================================================
/**
 * @file FieldEffectFootRideZimenba.cpp
 * @date 2015/11/13 14:51:59
 ...
 *  @brief  コンストラクタ
 */
EffectFootRideZimenba::EffectFootRideZimenba( void )
  :IEffectBase()
  ,m_pModel( NULL )
  ,m_pAllocator( NULL )
 ...
 *  @brief  初期化
 */
void EffectFootRideZimenba::Initialize( SetupData &setupData )
{
 ...
 *  @brief  破棄
 */
bool EffectFootRideZimenba::Terminate( void )
{
 ...
 *  @brief  更新
 */
void EffectFootRideZimenba::updateNormal( void )
{
 ...
 */
void EffectFootRideZimenba::Delete( void )
{
 ...
 *  @brief  モデルの作成
 */
void EffectFootRideZimenba::createModel( void *pModelBinary )
{
  // モデルリソース作成
 ...
 *  @brief  モーションの作成
 */
void EffectFootRideZimenba::createMotion( void *pMotionBinary )
{
 ...
 *  @brief  オフセットを設定
 */
void EffectFootRideZimenba::SetOffset( b32 isReverse , gfl2::math::Vector3 offset )
{
