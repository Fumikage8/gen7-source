//======================================================================
/**
 * @file FieldEffectFootRideKenta.cpp
 * @date 2015/11/13 14:47:19
 ...
 *  @brief  コンストラクタ
 */
EffectFootRideKenta::EffectFootRideKenta( void )
  :IEffectBase()
  ,m_pModel( NULL )
  ,m_pAllocator( NULL )
 ...
 *  @brief  初期化
 */
void EffectFootRideKenta::Initialize( SetupData &setupData )
{
 ...
 *  @brief  破棄
 */
bool EffectFootRideKenta::Terminate( void )
{
 ...
 *  @brief  更新
 */
void EffectFootRideKenta::updateNormal( void )
{
 ...
 */
void EffectFootRideKenta::Delete( void )
{
 ...
 *  @brief  モデルの作成
 */
void EffectFootRideKenta::createModel( void *pModelBinary )
{
  // モデルリソース作成
 ...
 *  @brief  モーションの作成
 */
void EffectFootRideKenta::createMotion( void *pMotionBinary )
{
 ...
 *  @brief  オフセットを設定
 */
void EffectFootRideKenta::SetOffset( b32 isReverse , gfl2::math::Vector3 offset )
{
