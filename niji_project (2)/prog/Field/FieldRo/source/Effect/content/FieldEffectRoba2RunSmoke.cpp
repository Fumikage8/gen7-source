//======================================================================
/**
 * @file FieldEffectRoba2RunSmoke.cpp
 ...
 *  @brief  コンストラクタ
 */
EffectRoba2RunSmoke::EffectRoba2RunSmoke( void )
: IEffectBase()
, m_pEffectHeap( NULL )
 ...
 *  @brief  初期化
 */
void EffectRoba2RunSmoke::Initialize( SetupData &setupData )
{
  ...
  m_pEffectSystem->CreateEmitterSetID( m_pEffectHandle, setupData.vPos, 0, EFFECT_RESOURCE_ROBA2_RUN_SMOKE );
}

/**
 *  @brief  破棄
 */
bool EffectRoba2RunSmoke::Terminate( void )
{
 ...
 *  @brief  オフセットを設定
 */
void EffectRoba2RunSmoke::SetOffset( gfl2::math::Vector3 offset,gfl2::math::Vector3 offsetQua )
{
  // エミッター
 ...
 *  @brief  更新処理
 */
void EffectRoba2RunSmoke::updateNormal( void )
{
  if( !m_pEffectHandle->GetEmitterSet() )
  {
    RequestDelete();
