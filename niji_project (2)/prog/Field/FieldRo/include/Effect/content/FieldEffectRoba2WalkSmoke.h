//======================================================================
/**
 * @file FieldEffectRoba2WalkSmoke.h
...
#if !defined __FIELD_EFFECT_ROBA2_WALK_SMOKE_H_INCLUDED__
#define __FIELD_EFFECT_ROBA2_WALK_SMOKE_H_INCLUDED__
#pragma once
...
class EffectRoba2WalkSmoke : public IEffectBase
{
  GFL_FORBID_COPY_AND_ASSIGN(EffectRoba2WalkSmoke);
...
public:
   ...
   *  @brief  コンストラクタ
   */
  EffectRoba2WalkSmoke( void );

  /**
   *  @brief  デストラクタ
   */
  virtual ~EffectRoba2WalkSmoke( void );
...
#endif // __FIELD_EFFECT_ROBA2_WALK_SMOKE_H_INCLUDED__