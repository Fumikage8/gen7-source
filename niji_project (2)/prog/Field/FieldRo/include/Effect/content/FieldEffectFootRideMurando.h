//======================================================================
/**
 * @file FieldEffectFootRideMurando.h
 * @date 2015/11/13 14:40:57
...
#if !defined __FIELD_EFFECT_FOOTRIDE_MURANDO_H_INCLUDED__
#define __FIELD_EFFECT_FOOTRIDE_MURANDO_H_INCLUDED__
#pragma once
...
class EffectFootRideMurando : public IEffectBase
{
  //! コピー禁止
  GFL_FORBID_COPY_AND_ASSIGN( EffectFootRideMurando );
...
public:
   ...
   *  @brief  コンストラクタ
   */
  EffectFootRideMurando( void );

  /**
   *  @brief  デストラクタ
   */
  virtual ~EffectFootRideMurando( void );
...
#endif // __FIELD_EFFECT_FOOTRIDE_MURANDO_H_INCLUDED__
