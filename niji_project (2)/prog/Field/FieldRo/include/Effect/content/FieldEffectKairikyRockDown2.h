//======================================================================
/**
 * @file FieldEffectKairikyRockDown2.h
 * @date 2017/01/19 15:06:59
...
#if !defined __FIELD_EFFECT_KAIRIKY_ROCKDOWN_2_H_INCLUDED__
#define __FIELD_EFFECT_KAIRIKY_ROCKDOWN_2_H_INCLUDED__
#pragma once
 ...
 *  @brief  カイリキ岩落下エフェクト（フェローチェマップの大きい岩専用）
 */
class EffectKairikyRockDown2 : public IEffectBase
{
  GFL_FORBID_COPY_AND_ASSIGN(EffectKairikyRockDown2);
...
public:
   ...
   *  @brief  コンストラクタ
   */
  EffectKairikyRockDown2(void);

  /**
   *  @brief  デストラクタ
   */
  virtual ~EffectKairikyRockDown2(void);
...
#endif // __FIELD_EFFECT_KAIRIKY_ROCKDOWN_2_H_INCLUDED__
