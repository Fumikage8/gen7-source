...
#if !defined __FIELD_EFFECT_SHARKRUN_H_INCLUDED__
#define __FIELD_EFFECT_SHARKRUN_H_INCLUDED__
#pragma once
 ...
 *  @brief  サメハダーの走りしぶき
 */
class EffectSharkRun : public IEffectBase
{
  GFL_FORBID_COPY_AND_ASSIGN(EffectSharkRun);
...
#endif // __FIELD_EFFECT_SHARKRUN_H_INCLUDED__
