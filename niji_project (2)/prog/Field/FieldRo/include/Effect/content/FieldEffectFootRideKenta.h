//======================================================================
/**
 * @file FieldEffectFootRideKenta.h
 * @date 2015/11/13 14:39:25
...
#if !defined __FIELD_EFFECT_FOOTRIDE_KENTA_H_INCLUDED__
#define __FIELD_EFFECT_FOOTRIDE_KENTA_H_INCLUDED__
#pragma once
...
class EffectFootRideKenta : public IEffectBase
{
  //! コピー禁止
  GFL_FORBID_COPY_AND_ASSIGN( EffectFootRideKenta );
...
public:
   ...
   *  @brief  コンストラクタ
   */
  EffectFootRideKenta( void );

  /**
   *  @brief  デストラクタ
   */
  virtual ~EffectFootRideKenta( void );
...
#endif // __FIELD_EFFECT_FOOTRIDE_KENTA_H_INCLUDED__
