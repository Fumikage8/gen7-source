//======================================================================
/**
 * @file FieldEffectFootRideKairiky.h
 * @date 2015/11/13 14:42:10
...
#if !defined __FIELD_EFFECT_FOOTRIDE_KAIRIKY_H_INCLUDED__
#define __FIELD_EFFECT_FOOTRIDE_KAIRIKY_H_INCLUDED__
#pragma once
...
class EffectFootRideKairiky : public IEffectBase
{
  //! コピー禁止
  GFL_FORBID_COPY_AND_ASSIGN( EffectFootRideKairiky );
...
public:
   ...
   *  @brief  コンストラクタ
   */
  EffectFootRideKairiky( void );

  /**
   *  @brief  デストラクタ
   */
  virtual ~EffectFootRideKairiky( void );
...
#endif // __FIELD_EFFECT_FOOTRIDE_KAIRIKY_H_INCLUDED__
