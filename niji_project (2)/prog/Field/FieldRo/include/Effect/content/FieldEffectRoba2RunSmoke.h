//======================================================================
/**
 * @file FieldEffectRoba2RunSmoke.h
...
#if !defined __FIELD_EFFECT_ROBA2_RUN_SMOKE_H_INCLUDED__
#define __FIELD_EFFECT_ROBA2_RUN_SMOKE_H_INCLUDED__
#pragma once
...
class EffectRoba2RunSmoke : public IEffectBase
{
  GFL_FORBID_COPY_AND_ASSIGN(EffectRoba2RunSmoke);
...
public:
   ...
   *  @brief  コンストラクタ
   */
  EffectRoba2RunSmoke( void );

  /**
   *  @brief  デストラクタ
   */
  virtual ~EffectRoba2RunSmoke( void );
...
#endif // __FIELD_EFFECT_ROBA2_RUN_SMOKE_H_INCLUDED__
