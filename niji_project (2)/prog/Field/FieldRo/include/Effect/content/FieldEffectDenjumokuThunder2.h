//======================================================================
/**
 * @file FieldEffectDenjumokuThunder2.h
 * @date 2017/01/26 16:59:14
...
#if !defined __FIELD_EFFECT_DENJUMOKU_THUNDER2_H_INCLUDED__
#define __FIELD_EFFECT_DENJUMOKU_THUNDER2_H_INCLUDED__
#pragma once
...
*  @brief  デンジュモクマップの雷2
*/
class EffectDenjumokuThunder2 : public IEffectBase
{
  GFL_FORBID_COPY_AND_ASSIGN(EffectDenjumokuThunder2);
...
public:
  ...
  *  @brief  コンストラクタ
  */
  EffectDenjumokuThunder2(void);

  /**
  *  @brief  デストラクタ
  */
  virtual ~EffectDenjumokuThunder2(void);
...
private:
  ...
  gfl2::Effect::Handle                *m_pEffectHandleRoot;
...
#endif // __FIELD_EFFECT_DENJUMOKU_THUNDER2_H_INCLUDED__
