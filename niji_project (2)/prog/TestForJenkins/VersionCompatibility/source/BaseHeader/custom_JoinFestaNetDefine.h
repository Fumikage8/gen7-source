#if !defined(CUSTOM_JOINFESTANETDEFINE_H_INCLUDED)
#define CUSTOM_JOINFESTANETDEFINE_H_INCLUDED
#pragma once
//==============================================================================
/**
 * @file   custom_JoinFestaNetDefine.h
 * @date   2016/10/28 Fri. 12:51:40
 * @author muto_yu
 * @brief  JoinFestaNetDefine.hからチェック用に定数定義のみを抽出
 * @par Copyright
...
#endif  /*  #if !defined(CUSTOM_JOINFESTANETDEFINE_H_INCLUDED)  */
