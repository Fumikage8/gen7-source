// ============================================================================
/*
 * @file SendPlayCompleteRequestSequence.cpp
...
*/
//------------------------------------------------------------------
SendPlayCompleteRequestSequence::SendPlayCompleteRequestSequence()
: m_pListener( NULL )
, m_dummyWaitCount( 0 )
{
...
*/
//------------------------------------------------------------------
gflnet2::ServerClient::REQUEST_SEQUENCE_STATE SendPlayCompleteRequestSequence::Update( void )
{
  ...
  case SEQ_END:
    {
      if( m_pListener )
      {
        m_pListener->OnPlayCompleteSuccess();
      }
    }
...
*/
//------------------------------------------------------------------
gflnet2::ServerClient::REQUEST_SEQUENCE_STATE SendPlayCompleteRequestSequence::UpdateCancel( void )
{
  return gflnet2::ServerClient::REQUEST_STATE_FINISH;
}
...
*/
//------------------------------------------------------------------
void SendPlayCompleteRequestSequence::RemoveListener( void )
{
  m_pListener = NULL;
}
...
*/
//------------------------------------------------------------------
void SendPlayCompleteRequestSequence::SetListener( BattleVideoResponseListener* pListener )
{
...
*/
//------------------------------------------------------------------
void SendPlayCompleteRequestSequence::SetRequestParam( BattleVideoRequestClient::COMPLETE_REQUEST_PARAM& pParam )
{
 ...
 */
//------------------------------------------------------------------
bool SendPlayCompleteRequestSequence::SetRatingStoreData( const nn::nex::DataStoreRatingTarget& target, const nn::nex::DataStoreRateObjectParam& param )
{
  // NexManager取得
 ...
 */
//------------------------------------------------------------------
void SendPlayCompleteRequestSequence::OnNexDataStoreSetRatingSuccess( const nn::nex::qInt8 slotId, nn::nex::DataStoreRatingInfo& rateInfo )
{
...
*/
//------------------------------------------------------------------
void SendPlayCompleteRequestSequence::OnNexDataStoreClientError( const nn::nex::qResult& result, u32 errorCode )
{
