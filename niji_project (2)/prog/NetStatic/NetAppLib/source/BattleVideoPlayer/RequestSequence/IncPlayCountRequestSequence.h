// ============================================================================
/*
 * @file IncPlayCountRequestSequence.h
 * @brief 再生回数をインクリメントするリクエストです。
 * @date 2015.06.23
 */
// ============================================================================
#if !defined( INCPLAYCOUNTREQUESTSEQUENCE_H_INCLUDE )
#define INCPLAYCOUNTREQUESTSEQUENCE_H_INCLUDE
#pragma once
...
//------------------------------------------------------------------
/**
* @brief  再生回数をインクリメントするリクエスト
*/
//------------------------------------------------------------------
class IncPlayCountRequestSequence :
  public gflnet2::ServerClient::RequestSequenceBase, public gflnet2::nex::NexDataStoreClientListener
{
  GFL_FORBID_COPY_AND_ASSIGN( IncPlayCountRequestSequence );
private:
...
public:
  ...
  */
  //------------------------------------------------------------------
  IncPlayCountRequestSequence();
  virtual~IncPlayCountRequestSequence();
...
public://RequestSequenceBaseのオーバーライド
  ...
  */
  //------------------------------------------------------------------
  void SetRequestParam( BattleVideoRequestClient::INC_REQUEST_PARAM& pParam );
...
private:
  ...
  BattleVideoRequestClient::INC_REQUEST_PARAM m_requestParam;
...
#endif // INCPLAYCOUNTREQUESTSEQUENCE_H_INCLUDE
