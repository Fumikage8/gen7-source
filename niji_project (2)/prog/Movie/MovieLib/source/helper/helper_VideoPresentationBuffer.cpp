...
/*---------------------------------------------------------------------------*
 File:        helper_VideoPresentationBuffer.cpp
...
/*---------------------------------------------------------------------------*
 Initialization of the video presentation buffer object
 *---------------------------------------------------------------------------*/

bool VideoPresentationBuffer::Initialize (gfl2::heap::NwAllocator* pAllocator,
...
void VideoPresentationBuffer::Finalize (movie::renderer::MobiclipRenderingPipeLine* renderingPipeLine)
{
    m_pAllocator = NULL;
