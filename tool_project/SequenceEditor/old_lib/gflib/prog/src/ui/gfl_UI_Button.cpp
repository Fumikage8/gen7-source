...
namespace gfl {
  namespace ui {
     ...
     * @param button       調べるボタン ( gfl::ui::BUTTON_xxxx )
     ...
     * @param targetState  チェック対象の入力状態
     * @return 押されている全てのボタン( gfl::ui::BUTTON_xxxx )の論理和
     */
    //-------------------------------------------------------------------------
     ...
     * @param targetState  チェック対象の入力状態
     * @return 押された全てのボタン( gfl::ui::BUTTON_xxxx )の論理和
     */
    //-------------------------------------------------------------------------
     ...
     * @param targetState  チェック対象の入力状態
     * @return 離された全てのボタン( gfl::ui::BUTTON_xxxx )の論理和
     */
    //-------------------------------------------------------------------------
     ...
     * @param targetState  チェック対象の入力状態
     * @return リピートを検出した全てのボタン( gfl::ui::BUTTON_xxxx )の論理和
     */
    //-------------------------------------------------------------------------
     ...
     *
     * @note AddButtonAssignment( gfl::ui::BUTTONID_A, gfl::ui::BUTTONID_L ) とした場合,
     ...
     *
     * @note RemoveButtonAssignment( gfl::ui::BUTTONID_A, gfl::ui::BUTTONID_L ) とした場合,
