//=============================================================================
/**
 * @file   gfl_UI_DeviceImplementerForGyroscope.h
...
#ifndef __GFL_UI_DEVICE_IMPLEMENTER_FOR_GYROSCOPE_H__
#define __GFL_UI_DEVICE_IMPLEMENTER_FOR_GYROSCOPE_H__
...
namespace gfl {
  namespace ui {
    ...
    public:
       ...
       */
      //--------------------------------------------------------------------------
      virtual const gfl::math::VEC3& GetAngleMagnification(void) const = 0;
       ...
       */
      //--------------------------------------------------------------------------
      virtual void SetAngleMagnification(const gfl::math::VEC3& value) = 0;
       ...
       */
      //--------------------------------------------------------------------------
      virtual void SetDirection( const gfl::math::MTX33& mtx ) = 0;
...
#endif  //__GFL_UI_DEVICE_IMPLEMENTER_FOR_GYROSCOPE_H__
