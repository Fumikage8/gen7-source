...
#ifndef __GFL_UI_GYROSCOPE_H__
#define __GFL_UI_GYROSCOPE_H__
#pragma once
  ...
  namespace ui {
    ...
    class Gyroscope : public Device
    {
      ...
      struct DetectiveData 
      {
        ...
        gfl::math::VEC3 speed;        // 角速度
        gfl::math::VEC3 angle;        // 回転角
        gfl::math::VEC3 direction_x;  // 姿勢ベクトル( x軸 )
        gfl::math::VEC3 direction_y;  // 姿勢ベクトル( y軸 )
        gfl::math::VEC3 direction_z;  // 姿勢ベクトル( z軸 )
      }; 
       ...
       */
      //-----------------------------------------------------------------------
      const gfl::math::VEC3& GetSpeed( void ) const;
       ...
       */
      //-----------------------------------------------------------------------
      const gfl::math::VEC3& GetAngleMagnification( void ) const;
       ...
       */
      //-----------------------------------------------------------------------
      void SetAngleMagnification( const gfl::math::VEC3& value );
       ...
       */
      //-----------------------------------------------------------------------
      const gfl::math::VEC3& GetAngle( void ) const;
       ...
       */
      //-----------------------------------------------------------------------
      const gfl::math::VEC3& GetDirectionOfX( void ) const;
       ...
       */
      //-----------------------------------------------------------------------
      const gfl::math::VEC3& GetDirectionOfY( void ) const;
       ...
       */
      //-----------------------------------------------------------------------
      const gfl::math::VEC3& GetDirectionOfZ( void ) const;
       ...
       */
      //-----------------------------------------------------------------------
      void SetDirection( const gfl::math::MTX33& mtx );
       ...
       */
      Gyroscope( gfl::heap::HeapBase* heap, DeviceImplementerForGyroscope* implementer );
