#ifndef __GFL_G3DH3DRESSKELETALANIM_H__
#define __GFL_G3DH3DRESSKELETALANIM_H__
#pragma once
//[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[
/**
 *	GAME FREAK inc.
 *
 *	@file		gfl_G3dH3dResSkeletalAnim.h
...
//=====================================
class H3dResSkeletalAnim : public H3dResAnim
{
  GFL_FORBID_COPY_AND_ASSIGN(H3dResSkeletalAnim);
...
public:
   ...
   */
  //-----------------------------------------------------------------------------
  H3dResSkeletalAnim(void);
  //-----------------------------------------------------------------------------
  /**
   *  @brief         デストラクタ
   */
  //-----------------------------------------------------------------------------
  virtual ~H3dResSkeletalAnim();
...
#endif // __GFL_G3DH3DRESSKELETALANIM_H__
