...
private:
  ...
  gfl::heap::HeapBase       *m_heap;                                    //!< ヒープ
  gfl::heap::HeapBase       *m_deviceHeap;                              //!< デバイスヒープ
  ...
  bool                       m_init;                                    //!< 初期化フラグ
  imgdb::Result              m_resultDetail;                            //!< SaveToSDCard()実行結果
  wchar_t                    m_filePath[imgdb::imgio::c_nMaxPathSize];  //!< 保存されたファイル名
