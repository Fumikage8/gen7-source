...
// The ctor.
QsciLexerPawn::QsciLexerPawn(QObject *parent, bool caseInsensitiveKeywords)
    : QsciLexer(parent),
...
// The dtor.
QsciLexerPawn::~QsciLexerPawn()
{
}


// Returns the language name.
const char *QsciLexerPawn::language() const
{
    return "C++";
}
...
const char *QsciLexerPawn::lexer() const
{
...
// words.
QStringList QsciLexerPawn::autoCompletionWordSeparators() const
{
    QStringList wl;
...
const char *QsciLexerPawn::blockStartKeyword(int *style) const
{
    if (style)
        *style = Keyword;
...
const char *QsciLexerPawn::blockStart(int *style) const
{
    if (style)
        *style = Operator;
...
const char *QsciLexerPawn::blockEnd(int *style) const
{
    if (style)
        *style = Operator;
...
int QsciLexerPawn::braceStyle() const
{
    return Operator;
}
...
const char *QsciLexerPawn::wordCharacters() const
{
...
QColor QsciLexerPawn::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool QsciLexerPawn::defaultEolFill(int style) const
{
...
QFont QsciLexerPawn::defaultFont(int style) const
{
    QFont f;
...
const char *QsciLexerPawn::keywords(int set) const
{
    if (set == 1)
        return
...
QString QsciLexerPawn::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor QsciLexerPawn::defaultPaper(int style) const
{
    switch (style)
    {
    case UnclosedString:
...
void QsciLexerPawn::refreshProperties()
{
    setAtElseProp();
    setCommentProp();
    setCompactProp();
...
bool QsciLexerPawn::readProperties(QSettings &qs,const QString &prefix)
{
    int rc = true;
...
bool QsciLexerPawn::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
void QsciLexerPawn::setFoldAtElse(bool fold)
{
    fold_atelse = fold;
...
void QsciLexerPawn::setAtElseProp()
{
...
void QsciLexerPawn::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void QsciLexerPawn::setCommentProp()
{
...
void QsciLexerPawn::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void QsciLexerPawn::setCompactProp()
{
...
void QsciLexerPawn::setFoldPreprocessor(bool fold)
{
    fold_preproc = fold;
...
void QsciLexerPawn::setPreprocProp()
{
...
void QsciLexerPawn::setStylePreprocessor(bool style)
{
    style_preproc = style;
...
void QsciLexerPawn::setStylePreprocProp()
{
...
void QsciLexerPawn::setDollarsAllowed(bool allowed)
{
    dollars = allowed;
...
void QsciLexerPawn::setDollarsProp()
{
