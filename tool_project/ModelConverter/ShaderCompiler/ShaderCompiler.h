...
class ShaderCompiler : public rapidxml::xml_document<>
{
public:
...
private:
	gfl2::renderingengine::scenegraph::resource::MathFormulaType GetMathFormulaTypeFromAttributeName( const char* name );
	...
	std::string				m_ShaderName[Type::Max];
