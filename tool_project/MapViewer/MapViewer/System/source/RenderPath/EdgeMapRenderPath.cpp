...
:poke_3d::renderer::EdgeMapSceneRenderPath(modelNum)
...
#endif  //プラットフォーム分岐
  poke_3d::renderer::EdgeMapSceneRenderPath::LoadResources(static_cast<c8*>(binData.GetData(0)),shaderArr,GFL_NELEMS(shaderArr),texArr,GFL_NELEMS(texArr));
