...
namespace ModelViewer
{
  ...
  {
    public string gfmdlFilePath;      //!< @brief 変換前のgfmdlデータ
    public string gfbmdlFilePath;
    public Tuple<string, string, string>[] shaderFilePathTuples;
    public Tuple<string, PokemonModelDataManager.GfmdlTextureType>[] textureFilePathTuples;
    public Tuple<string, PokemonModelDataManager.GfmdlTextureType>[] textureRareFilePathTuples;
  }
