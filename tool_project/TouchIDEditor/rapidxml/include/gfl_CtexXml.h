...
private:
	...
	static void SetCtexTextureL8(gfl::cmdl::Model* model, gfl::xml::Node* i_node, s32 gl_fmt, s32 gl_type, gfl::cmdl::Material::TextureMapper* tm);
	static void SetCtexTextureLa8(gfl::cmdl::Model* model, gfl::xml::Node* i_node, s32 gl_fmt, s32 gl_type, gfl::cmdl::Material::TextureMapper* tm);
	...
	static QImage GetCtexQImageL8(gfl::cmdl::Model* model, gfl::xml::Node* i_node, QImage::Format fmt);
	static QImage GetCtexQImageLa8(gfl::cmdl::Model* model, gfl::xml::Node* i_node, QImage::Format fmt);
