...
enum
{
  ...
  HEAPID_DEBUG,
  HEAPID_DEBUG_DEBUGGER,  // PCデバッグ用ヒープ
  ...
  HEAPID_DEBUG_FS_MATCH_CHECK,            // 親ヒープはHEAPID_DEBUG_DEVICE(別にデバイスメモリでなくてもいいのだが)。リクエスト対応確認に使うメモリ。

  HEAPID_DEBUG_DYNAMIC_HEADER_DEVICE,     // 親ヒープはHEAPID_DEBUG_DEVICE. 動的ヘッダシステム用ヒープ
