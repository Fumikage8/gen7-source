...
public:
	...
	s32 GetTextureMapperCoordCount( ) const {
		return ::std::min( GetTextureMapperCount( ), GetTextureCoordinatorCount( ) );
	}
...
public:
	...
	public:
		...
		TextureTabInfo( const QString& fname, Material* mate, u8* data, u32 width, u32 height ) : m_FileName( fname ), m_pMaterial( mate ), m_pData(data), m_Width(width), m_Height(height) {
		}
