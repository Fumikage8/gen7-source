...
ipcnet::ServerMain* g_ServerMain;
...
//	QTextCodec::setCodecForLocale(QTextCodec::codecForName("Shift-JIS"));
 ...
 // SetConsoleCtrlHandler(HandlerRoutine, TRUE);
  ...
  mpMyWindow->show();
	...
	g_ServerMain = new ipcnet::ServerMain(mpMyWindow);
