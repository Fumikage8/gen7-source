...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MyTray_t, stringdata) + ofs \
...
const QMetaObject MyTray::staticMetaObject = {
    { &QSystemTrayIcon::staticMetaObject, qt_meta_stringdata_MyTray.data,
      qt_meta_data_MyTray,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyTray.stringdata))
...
void *MyWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ipcnet::OutputListener"))
        return static_cast< ipcnet::OutputListener*>(const_cast< MyWindow*>(this));
